...
"use strict";class ListRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.createHeader()+this.createVocabsTable();this.browser.elem.innerHTML=this.util.createMainContent("schema:DataSet",e)}createHeader(){return"<h1>"+this.browser.list["schema:name"]+"</h1>"+this.util.createExternalLinkLegend()}createVocabsTable(){return this.util.createDefinitionTable(["Name","IRI","Author","Description"],this.createVocabsTbody(),{class:"supertype"})}createVocabsTbody(){return this.browser.list["schema:hasPart"].map(e=>this.util.createTableRow("http://vocab.sti2.at/ds/Vocabulary",e["@id"],"schema:name",this.util.createJSLink("voc",e["@id"].split("/").pop(),e["schema:name"]||"No Name"),this.createVocabsSideCols(e))).join("")}createVocabsSideCols(e){return'<td property="@id">'+this.util.createExternalLink(e["@id"])+'</td><td property="schema:author">'+(e["schema:author"]&&e["schema:author"]["schema:name"]||"")+'</td><td property="schema:description">'+(e["schema:description"]||"")+"</td>"}}module.exports=ListRenderer;
