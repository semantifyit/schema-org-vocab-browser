...
"use strict";function asyncGeneratorStep(t,e,r,n,a,o,i){try{var s=t[o](i),c=s.value}catch(t){return void r(t)}s.done?e(c):Promise.resolve(c).then(n,a)}function _asyncToGenerator(t){return function(){var e=this,r=arguments;return new Promise(function(n,a){var o=t.apply(e,r);function i(t){asyncGeneratorStep(o,n,a,i,s,"next",t)}function s(t){asyncGeneratorStep(o,n,a,i,s,"throw",t)}i(void 0)})}}class Util{constructor(t){this.browser=t}parseToObject(t){var e=this;return _asyncToGenerator(function*(){var r;return e.isString(t)?(r=e.isValidUrl(t)?yield e.getJsonld(t):t,JSON.parse(r)):t})()}isString(t){return"string"==typeof t||t instanceof String}isValidUrl(t){try{new URL(t)}catch(t){return!1}return!0}getJsonld(t){return new Promise(function(e,r){var n=new XMLHttpRequest;n.open("GET",t),n.setRequestHeader("Accept","application/ld+json"),n.onload=function(){this.status>=200&&this.status<300?e(n.response):r({status:this.status,statusText:n.statusText})},n.onerror=function(){r({status:this.status,statusText:n.statusText})},n.send()})}createIriWithQueryParam(t,e){var r=new URLSearchParams(window.location.search);e&&""!==e?r.set(t,e):r.delete(t);var n=r.toString();return window.location.protocol+"//"+(window.location.host?window.location.host:"")+window.location.pathname+(""!==n?"?"+n:"")}createHtmlTableRow(t,e,r,n,a){var o=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null,i=this.createHtmlMainCol(r,n,o);return'<tr typeof="'.concat(t,'" resource="').concat(e,'">\n            ').concat(i," ").concat(a,"</tr>")}createHtmlMainCol(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=this.createHtmlCodeWithLink(e,{property:t});return"<th ".concat(r?' class="'+r+'"':"",' scope="row">').concat(n,"</th>")}createHtmlCodeWithLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,a=this.createHtmlAttr(e),o=this.createHtmlFullLink(t,r,n);return"<code ".concat(a,">").concat(o,"</code>")}createHtmlFullLink(t,e,r){var n;try{n=this.browser.sdoAdapter.getTerm(t)}catch(t){n=null}return(r?this.createHtmlSemanticLink(r,t):"")+(n?this.createLink(t,e):t)}createInternalLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;e=this.escHtml(e);var n=this.browser.locationControl?this.createInternalHref(t):"javascript:void(0)",a=this.browser.locationControl?'onclick="return false;"':"",o=this.createHtmlAttr(r),i='data-state-changes="'+encodeURIComponent(JSON.stringify(t))+'"';return'<a class="a-js-link" href="'.concat(n,'" ').concat(o," ").concat(a," ").concat(i,">\n        ").concat(e,"</a>")}createInternalHref(t){var e,r=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=this.createNavigationState(t),a=window.location.protocol+"//"+(window.location.host?window.location.host:""),o=[];n.listId?(e=a+"/list/"+n.listId,n.vocId&&o.push(["voc",n.vocId])):e=a+"/voc/"+n.vocId,n.termURI&&o.push(["term",n.termURI]),n.format&&o.push(["format",n.format]);for(var i=0;i<o.length;i++){var s="&";0===i&&(s="?"),e+=s+encodeURIComponent(o[i][0])+"="+encodeURIComponent(o[i][1])}return r?this.escHtml(e):e}createNavigationState(t){var e={};for(var r of["listId","vocId","termURI","format"])void 0!==t[r]?e[r]=t[r]:e[r]=this.browser[r];return e}escHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}createHtmlAttr(t){return t?Object.entries(t).map(t=>" "+this.escHtml(t[0])+'="'+this.escHtml(t[1])+'"').join(""):""}createExternalLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=new URL(t);if(window.location.hostname!==n.hostname){var a=" "+this.createExternalLinkStyle(t);r?r.hasOwnProperty("style")?r.style=r.style+a:r.style=a:r={style:a},r.target="_blank"}return'<a href="'+this.escHtml(t)+'"'+this.createHtmlAttr(r)+">"+(e?this.prettyPrintIri(e):this.prettyPrintIri(t))+"</a>"}createExternalLinkStyle(t){var e="background-position: center right; \n            background-repeat: no-repeat; \n            background-size: 10px 10px; \n            padding-right: 13px; ";return-1===t.indexOf("https://schema.org")&&-1===t.indexOf("http://schema.org")?e+="background-image: url(https://raw.githubusercontent.com/semantifyit/schema-org-vocab-browser/main/images/external-link-icon-blue.png);":e+="background-image: url(https://raw.githubusercontent.com/semantifyit/schema-org-vocab-browser/main/images/external-link-icon-red.png);",e}prettyPrintIri(t){return t.replace(/^(schema:|https?:\/\/schema.org\/)(.+)/,"$2")}createHtmlMainContent(t,e){var r=window.location;return'<div id="mainContent" vocab="http://schema.org/" typeof="'.concat(t,'" resource="').concat(r,'">').concat(e,"</div>")}underscore(t){return t.replace(/ /g,"_")}getTypeStructure(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"getSuperClasses",r=t[e](!1);if(0===r.length)return[[t.getIRI(!0)]];var n=[];return r.forEach(r=>{var a=this.browser.sdoAdapter.getTerm(r);this.getTypeStructure(a,e).forEach(e=>{e.push(t.getIRI(!0)),n.push(e)})}),n}createHtmlHeader(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"",n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"",a=this.browser.term,o=a.getIRI(!0),i=a.getDescription()||"",s="(from Vocabulary: "+this.createInternalLink({termURI:null},this.browser.getVocabName()||"Vocabulary")+")",c=this.createHtmlExternalLinkLegend(),l=this.createHtmlTypeStructureBreadcrumbs(t,e,r,n);return'<span style="float: right;">'.concat(s,'</span>\n            <h1 property="rdfs:label" class="page-title">').concat(o,"</h1>\n            ").concat(c," ").concat(l,'\n            <div property="rdfs:comment">').concat(i,"<br><br></div>")}createHtmlExternalLinkLegend(){var t="margin-right: 3px; "+this.createExternalLinkStyle(""),e="margin-right: 3px; "+this.createExternalLinkStyle("https://schema.org")+" margin-left: 6px;";return'<p style="font-size: 12px; margin-top: 0">\n            (<span style="'.concat(t,'"></span>External link\n            <span style="').concat(e,'"></span>External link to schema.org)</p>')}createHtmlTypeStructureBreadcrumbs(t,e,r,n){return"<h4>"+t.map(t=>'<span class="breadcrumbs">'+r+t.map((r,a)=>{var o="";return(""===n&&a+2===t.length||""!==n&&a+1===t.length)&&(o+=this.createHtmlSemanticLink(e,r)),o+=this.createLink(r)}).join(" > ")+n+"</span>").join("<br>")+"</h4>"}createHtmlSemanticLink(t,e){var r=this.escHtml(t),n=this.escHtml(this.createHref(e));return'<link property="'.concat(r,'" href="').concat(n,'">')}createHref(t){return this.isTermOfVocab(t)?this.createIriWithQueryParam("term",t):this.browser.sdoAdapter.getTerm(t).getIRI()}isTermOfVocab(t){return this.browser.vocab&&(this.browser.classes.includes(t)||this.browser.properties.includes(t)||this.browser.enumerations.includes(t)||this.browser.enumerationMembers.includes(t)||this.browser.dataTypes.includes(t))}createLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.isTermOfVocab(t)?this.createInternalLink({termURI:t},t,e):this.createExternalLink(this.createHref(t),t,e)}createPropertyTableRow(t){var e=arguments.length>1&&void 0!==arguments[1]&&arguments[1];return this.createHtmlTableRow("rdf:Property",this.createHref(t),"rdfs:label",this.createLink(t),this.createHtmlPropertySideCols(t,e),"prop-name")}createHtmlPropertySideCols(t,e){var r=this.browser.sdoAdapter.getProperty(t),n=this.createHtmlPropertyRange(r,e),a=r.getDescription()||"";return'<td class="prop-etc">'.concat(n,'</td>\n            <td class="prop-desc" property="rdfs:comment">').concat(a,"</td>")}createHtmlPropertyRange(t,e){var r="";return e||(r=t.getRanges(!1).map(t=>this.createHtmlSemanticLink("rangeIncludes",t)+this.createLink(t)).join("&nbsp; or <br>")),r+t.getDomains(!1).map(t=>this.createHtmlSemanticLink("domainIncludes",t)+(e?this.createLink(t):"")).join(e?"&nbsp; or <br>":"")}createHtmlDefinitionTable(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;Array.isArray(t)||(t=[t]),Array.isArray(e)||(e=[e]);var n=t.map(t=>"<th>"+t+"</th>").join(""),a=e[0].startsWith("<tr")?e.join(""):e.map(t=>"<tr>"+t+"</tr>").join(""),o=this.createHtmlAttr(r);return'<table class="definition-table table">\n            <thead><tr>'.concat(n,"</tr></thead>\n            <tbody ").concat(o,">").concat(a,"</tbody></table>")}createHtmlRangesOf(){var t=arguments.length>0&&void 0!==arguments[0]&&arguments[0],e=this.browser.term.isRangeOf(!1);if(0===e.length)return"";var r=e.map(t=>this.createPropertyTableRow(t,!0)),n=this.createLink(this.browser.term.getIRI(!0)),a=t?"and its enumeration members or subtypes ":"",o=this.createHtmlDefinitionTable(["Property","On Types","Description"],r);return'<div id="incoming">Instances of '.concat(n," ").concat(a,"may appear as a value for the following properties\n            </div><br>").concat(o)}getFileHost(){return this.browser.selfFileHost?window.location.origin:"https://semantify.it"}}module.exports=Util;

},{}],85:[function(require,module,exports){
"use strict";var TYPES_PLURAL={Class:"Classes",Property:"Properties",Enumeration:"Enumerations","Enumeration Member":"Enumeration Members","Data Type":"Data Types"};class VocabRenderer{constructor(e){this.browser=e,this.util=this.browser.util}renderJsonld(){var e=JSON.stringify(this.browser.vocab,null,2);this.browser.targetElement.innerHTML='<pre style="'.concat("font-size: medium; \n            background: none; \n            text-align: left; \n            width: auto; \n            padding: 0; \n            overflow: visible; \n            color: rgb(0, 0, 0); \n            line-height: normal; ä\n            display: block; \n            font-family: monospace; \n            margin: 1em 0; \n            word-wrap: break-word; \n            white-space: pre-wrap;",'">').concat(e,"</pre>")}render(){var e=this.createHeading()+this.createNamespaces()+this.createContentSection()+this.createSection(this.browser.classes,"Class")+this.createSection(this.browser.properties,"Property")+this.createSection(this.browser.enumerations,"Enumeration")+this.createSection(this.browser.enumerationMembers,"Enumeration Member")+this.createSection(this.browser.dataTypes,"Data Type");this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("schema:DataSet",e),""!==window.location.hash&&this.browser.scrollToSection(window.location.hash.substring(1))}createHeading(){var e;e=this.browser.locationControl?this.util.createInternalLink({format:"jsonld"},"JSON-LD serialization"):'<a href="https://semantify.it/voc/'.concat(this.browser.vocId,'?format=jsonld" target="_blank">JSON-LD serialization</a>');var t=this.browser.list?" | from List: "+this.util.createInternalLink({vocId:null},this.browser.list["schema:name"]):"",r=this.browser.getVocabName()||"Vocabulary",n=this.util.createHtmlExternalLinkLegend();return'<span style="float: right;">('.concat(e," ").concat(t,")</span>\n                <h1>").concat(r,"</h1>").concat(n)}createNamespaces(){return'<h2 style="margin: revert;">Namespaces</h2><ul>'+Object.entries(this.browser.namespaces).map(e=>"<li>"+e[0]+": "+this.util.createExternalLink(e[1])+"</li>").join("")+"</ul>"}createContentSection(){return'<h2 style="margin: revert;">Content</h2><ul>'+this.createContentListElement(this.browser.classes,"Class")+this.createContentListElement(this.browser.properties,"Property")+this.createContentListElement(this.browser.enumerations,"Enumeration")+this.createContentListElement(this.browser.enumerationMembers,"Enumeration Member")+this.createContentListElement(this.browser.dataTypes,"Data Type")+"</ul>"}createContentListElement(e,t){if(0===e.length)return"";var r=TYPES_PLURAL[t],n=this.browser.locationControl?"#"+this.util.underscore(r):"javascript:void(0)",i=this.browser.locationControl?'onclick="return false;"':"",a=e.length+" "+(1===e.length?t:r);return'<li><a class="a-section-link" href="'.concat(n,'" data-section-link="').concat(r,'" ').concat(i,">").concat(a,"</a></li>")}createSection(e,t){if(0!==e.length){var r,n=TYPES_PLURAL[t];return r="Enumeration Member"===t?[t,"of Enumeration","Description"]:[t,"Description"],'<h2 id="'+this.util.underscore(n)+'">'+n+"</h2>"+this.util.createHtmlDefinitionTable(r,this.createSectionTbody(e,t),{class:"supertype"})}return""}createSectionTbody(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return e.map(e=>{var r=this.browser.sdoAdapter.getTerm(e),n="";if("Enumeration Member"===t){var i="";try{var a=this.browser.sdoAdapter.getEnumerationMember(e).getDomainEnumerations(!1);for(var s of a)i+=this.util.createInternalLink({termURI:s},s)+"</br>"}catch(e){}n+="<td>".concat(i,"</td>")}return n+='<td property="rdfs:comment">'+(r.getDescription()||"")+"</td>",this.util.createHtmlTableRow(r.getTermType(),this.util.createIriWithQueryParam("term",e),"@id",this.util.createInternalLink({termURI:e},e),n)}).join("")}}module.exports=VocabRenderer;
