...
"use strict";class ListRenderer{constructor(t){this.browser=t,this.util=this.browser.util}render(){var t=this.createHtmlHeader()+this.createHtmlVocabsTable();this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("schema:DataSet",t)}createHtmlHeader(){var t=this.browser.list["schema:name"],e=this.util.createHtmlExternalLinkLegend(),a=this.browser.list["schema:description"]||"";return"<h1>".concat(t,"</h1>\n            ").concat(e,"\n            ").concat(a)}createHtmlVocabsTable(){return this.util.createHtmlDefinitionTable(["Name","IRI","Author","Description"],this.createHtmlVocabsTbody(),{class:"supertype"})}createHtmlVocabsTbody(){return this.browser.list["schema:hasPart"].map(t=>this.util.createHtmlTableRow("http://vocab.sti2.at/ds/Vocabulary",t["@id"],"schema:name",this.util.createHtmlJSLink("voc",t["@id"].split("/").pop(),t["schema:name"]||"No Name"),this.createHtmlVocabsSideCols(t))).join("")}createHtmlVocabsSideCols(t){var e=this.util.createExternalLink(t["@id"]),a=t["schema:author"]&&t["schema:author"]["schema:name"]||"",r=t["schema:description"]||"";return'<td property="@id">'.concat(e,'</td>\n            <td property="schema:author">').concat(a,'</td>\n            <td property="schema:description">').concat(r,"</td>")}}module.exports=ListRenderer;

},{}],82:[function(require,module,exports){
"use strict";class PropertyRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.createHtmlStartBreadcrumbs(),t=this.util.getTypeStructure(this.browser.term,"getSuperProperties"),r=this.util.createHtmlHeader(t,"rdfs:subPropertyOf",e)+this.createHtmlRanges()+this.createHtmlDomainIncludes()+this.createHtmlSuperProperties()+this.createHtmlSubProperties();this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("rdf:Property",r)}createHtmlStartBreadcrumbs(){return this.util.createLink("schema:Thing")+" > "+this.util.createLink("schema:Property",{title:"Defined in section: meta.schema.org"})+" > "}createHtmlRanges(){var e=this.browser.term.getRanges(!1).map(e=>{var t={title:"The '"+this.browser.term.getIRI(!0)+"' property has values that include instances of the '"+e+"' type."};return this.util.createHtmlLink(e,null,t,"rangeIncludes")}).join("<br>");return this.util.createHtmlDefinitionTable("Values expected to be one of these types","<td>"+e+"</td>")}createHtmlDomainIncludes(){var e=this.browser.term.getDomains(!1).map(e=>{var t={title:"The '"+this.browser.term.getIRI(!0)+"' property is used on the '"+e+"' type"};return this.util.createHtmlLink(e,null,t,"domainIncludes")}).join("<br>");return this.util.createHtmlDefinitionTable("Used on these types","<td>"+e+"</td>")}createHtmlSuperProperties(){var e=this.browser.term.getSuperProperties(!1);return this.createHtmlRelatedProperties(e,"Super-properties")}createHtmlRelatedProperties(e,t){if(0===e.length)return"";var r=e.map(e=>{var t={title:e+": ''"+(this.browser.sdoAdapter.getProperty(e).getDescription()||"")+"''"};return this.util.createHtmlLink(e,null,t)}).join("<br>");return this.util.createHtmlDefinitionTable(t,"<td>"+r+"</td>")}createHtmlSubProperties(){var e=this.browser.term.getSubProperties(!1);return this.createHtmlRelatedProperties(e,"Sub-properties")}}module.exports=PropertyRenderer;

},{}],83:[function(require,module,exports){
"use strict";var _schemaOrgAdapter=_interopRequireDefault(require("schema-org-adapter")),_Util=_interopRequireDefault(require("./Util")),_ListRenderer=_interopRequireDefault(require("./ListRenderer")),_VocabRenderer=_interopRequireDefault(require("./VocabRenderer")),_ClassRenderer=_interopRequireDefault(require("./ClassRenderer")),_PropertyRenderer=_interopRequireDefault(require("./PropertyRenderer")),_EnumerationRenderer=_interopRequireDefault(require("./EnumerationRenderer")),_EnumerationMemberRenderer=_interopRequireDefault(require("./EnumerationMemberRenderer")),_DataTypeRenderer=_interopRequireDefault(require("./DataTypeRenderer"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function asyncGeneratorStep(e,r,t,n,a,i,s){try{var o=e[i](s),d=o.value}catch(e){return void t(e)}o.done?r(d):Promise.resolve(d).then(n,a)}function _asyncToGenerator(e){return function(){var r=this,t=arguments;return new Promise(function(n,a){var i=e.apply(r,t);function s(e){asyncGeneratorStep(i,n,a,s,o,"next",e)}function o(e){asyncGeneratorStep(i,n,a,s,o,"throw",e)}s(void 0)})}}var BROWSER_TYPES={VOCAB:"VOCAB",LIST:"LIST"};class SDOVocabBrowser{constructor(e,r){var t=this,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:BROWSER_TYPES.VOCAB;this.targetElement=e,this.vocabOrList=r,this.type=n,this.util=new _Util.default(this),this.listRenderer=new _ListRenderer.default(this),this.vocabRenderer=new _VocabRenderer.default(this),this.classRenderer=new _ClassRenderer.default(this),this.propertyRenderer=new _PropertyRenderer.default(this),this.enumerationRenderer=new _EnumerationRenderer.default(this),this.enumerationMemberRenderer=new _EnumerationMemberRenderer.default(this),this.dataTypeRenderer=new _DataTypeRenderer.default(this),window.addEventListener("popstate",_asyncToGenerator(function*(){yield t.render()}))}render(){var e=this;return _asyncToGenerator(function*(){if(e.targetElement.innerHTML='<img src="https://raw.githubusercontent.com/semantifyit/schema-org-vocab-browser/main/images/loading.gif"\n            alt="Loading Animation" style="margin-top: 6px">',yield e.init(),e.isListRendering())e.listRenderer.render();else if(e.isVocabRendering()){var r=new URLSearchParams(window.location.search).get("format");r&&"jsonld"===r?e.vocabRenderer.renderJsonld():e.vocabRenderer.render()}else e.isTermRendering()&&e.renderTerm();e.addJSLinkEventListener(),document.body.scrollTop=document.documentElement.scrollTop=0})()}init(){var e=this;return _asyncToGenerator(function*(){e.listNeedsInit()&&(yield e.initList()),e.vocabNeedsInit()&&(yield e.initVocab())})()}listNeedsInit(){return this.type===BROWSER_TYPES.LIST&&!this.list}initList(){var e=this;return _asyncToGenerator(function*(){e.list=yield e.util.parseToObject(e.vocabOrList)})()}vocabNeedsInit(){var e=new URLSearchParams(window.location.search).get("voc");return this.type===BROWSER_TYPES.LIST&&e&&e!==this.vocUID||this.type===BROWSER_TYPES.VOCAB&&!this.vocab}initVocab(){var e=this;return _asyncToGenerator(function*(){if(e.type===BROWSER_TYPES.VOCAB)e.vocab=yield e.util.parseToObject(e.vocabOrList);else if(e.type===BROWSER_TYPES.LIST){var r=new URLSearchParams(window.location.search);for(var t of(e.vocUID=r.get("voc"),e.list["schema:hasPart"])){var n=t["@id"];if(n.split("/").pop()===e.vocUID){e.vocab=yield e.util.parseToObject(n),e.vocName=t["schema:name"];break}}}yield e.initSDOAdapter()})()}initSDOAdapter(){var e=this;return _asyncToGenerator(function*(){e.sdoAdapter=new _schemaOrgAdapter.default;var r=yield e.sdoAdapter.constructSDOVocabularyURL("latest");yield e.sdoAdapter.addVocabularies([r,e.vocab]),e.namespaces=e.sdoAdapter.getVocabularies(),delete e.namespaces.schema;var t=Object.keys(e.namespaces);e.classes=e.sdoAdapter.getListOfClasses({fromVocabulary:t}),e.properties=e.sdoAdapter.getListOfProperties({fromVocabulary:t}),e.enumerations=e.sdoAdapter.getListOfEnumerations({fromVocabulary:t}),e.enumerationMembers=e.sdoAdapter.getListOfEnumerationMembers({fromVocabulary:t}),e.dataTypes=e.sdoAdapter.getListOfDataTypes({fromVocabulary:t})})()}isListRendering(){var e=new URLSearchParams(window.location.search);return this.type===BROWSER_TYPES.LIST&&!e.get("voc")}isVocabRendering(){var e=new URLSearchParams(window.location.search);return this.type===BROWSER_TYPES.LIST&&e.get("voc")&&!e.get("term")||this.type===BROWSER_TYPES.VOCAB&&!e.get("term")}isTermRendering(){return null!==new URLSearchParams(window.location.search).get("term")}renderTerm(){var e=new URLSearchParams(window.location.search);switch(this.term=this.sdoAdapter.getTerm(e.get("term")),this.term.getTermType()){case"rdfs:Class":this.classRenderer.render();break;case"rdf:Property":this.propertyRenderer.render();break;case"schema:Enumeration":this.enumerationRenderer.render();break;case"soa:EnumerationMember":this.enumerationMemberRenderer.render();break;case"schema:DataType":this.dataTypeRenderer.render()}}addJSLinkEventListener(){var e=this,r=this.targetElement.getElementsByClassName("a-js-link"),t=function(r){r.addEventListener("click",function(){var t=_asyncToGenerator(function*(t){t.ctrlKey?window.open(r.href):(history.pushState(null,null,r.href),yield e.render())});return function(e){return t.apply(this,arguments)}}())};for(var n of r)t(n)}}module.exports=SDOVocabBrowser;
...
"use strict";function asyncGeneratorStep(t,e,r,n,a,i,s){try{var c=t[i](s),o=c.value}catch(t){return void r(t)}c.done?e(o):Promise.resolve(o).then(n,a)}function _asyncToGenerator(t){return function(){var e=this,r=arguments;return new Promise(function(n,a){var i=t.apply(e,r);function s(t){asyncGeneratorStep(i,n,a,s,c,"next",t)}function c(t){asyncGeneratorStep(i,n,a,s,c,"throw",t)}s(void 0)})}}class Util{constructor(t){this.browser=t}parseToObject(t){var e=this;return _asyncToGenerator(function*(){var r;return e.isString(t)?(r=e.isValidUrl(t)?yield e.getJsonld(t):t,JSON.parse(r)):t})()}isString(t){return"string"==typeof t||t instanceof String}isValidUrl(t){try{new URL(t)}catch(t){return!1}return!0}getJsonld(t){return new Promise(function(e,r){var n=new XMLHttpRequest;n.open("GET",t),n.setRequestHeader("Accept","application/ld+json"),n.onload=function(){this.status>=200&&this.status<300?e(n.response):r({status:this.status,statusText:n.statusText})},n.onerror=function(){r({status:this.status,statusText:n.statusText})},n.send()})}createIriWithQueryParam(t,e){var r=new URLSearchParams(window.location.search);e&&""!==e?r.set(t,e):r.delete(t);var n=r.toString();return window.location.protocol+"//"+(window.location.host?window.location.host:"")+window.location.pathname+(""!==n?"?"+n:"")}createHtmlTableRow(t,e,r,n,a){var i=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null,s=this.createHtmlMainCol(r,n,i);return'<tr typeof="'.concat(t,'" resource="').concat(e,'">\n            ').concat(s," ").concat(a,"</tr>")}createHtmlMainCol(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=this.createHtmlLink(e,{property:t});return"<th ".concat(r?' class="'+r+'"':"",' scope="row">').concat(n,"</th>")}createHtmlLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,a=this.createHtmlAttr(e),i=this.createHtmlFullLink(t,r,n);return"<code ".concat(a,">").concat(i,"</code>")}createHtmlFullLink(t,e,r){var n;try{n=this.browser.sdoAdapter.getTerm(t)}catch(t){n=null}return(r?this.createHtmlSemanticLink(r,t):"")+(n?this.createLink(t,e):t)}createHtmlJSLink(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,a=this.createIriWithQueryParam(t,e),i=this.escHtml(a),s=this.createHtmlAttr(n),c=r?this.escHtml(r):this.escHtml(e);return'<a class="a-js-link" href="'.concat(i,'" onclick="return false;" ').concat(s,">\n            ").concat(c,"</a>")}escHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}createHtmlAttr(t){return t?Object.entries(t).map(t=>" "+this.escHtml(t[0])+'="'+this.escHtml(t[1])+'"').join(""):""}createExternalLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=new URL(t);if(window.location.hostname!==n.hostname){var a=" "+this.createExternalLinkStyle(t);r?r.hasOwnProperty("style")?r.style=r.style+a:r.style=a:r={style:a},r.target="_blank"}return'<a href="'+this.escHtml(t)+'"'+this.createHtmlAttr(r)+">"+(e?this.prettyPrintIri(e):this.prettyPrintIri(t))+"</a>"}createExternalLinkStyle(t){var e="background-position: center right; \n            background-repeat: no-repeat; \n            background-size: 10px 10px; \n            padding-right: 13px; ";return-1===t.indexOf("https://schema.org")&&-1===t.indexOf("http://schema.org")?e+="background-image: url(https://raw.githubusercontent.com/semantifyit/schema-org-vocab-browser/main/images/external-link-icon-blue.png);":e+="background-image: url(https://raw.githubusercontent.com/semantifyit/schema-org-vocab-browser/main/images/external-link-icon-red.png);",e}prettyPrintIri(t){return t.replace(/^(schema:|https?:\/\/schema.org\/)(.+)/,"$2")}createHtmlMainContent(t,e){var r=window.location;return'<div id="mainContent" vocab="http://schema.org/" typeof="'.concat(t,'" resource="').concat(r,'">').concat(e,"</div>")}underscore(t){return t.replace(/ /g,"_")}getTypeStructure(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"getSuperClasses",r=t[e](!1);if(0===r.length)return[[t.getIRI(!0)]];var n=[];return r.forEach(r=>{var a=this.browser.sdoAdapter.getTerm(r);this.getTypeStructure(a,e).forEach(e=>{e.push(t.getIRI(!0)),n.push(e)})}),n}createHtmlHeader(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"",n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"",a=this.browser.term,i=a.getIRI(!0),s=a.getDescription()||"",c=this.browser.vocName?"(from Vocabulary: "+this.createHtmlJSLink("term",null,this.browser.vocName)+")":"(go to "+this.createHtmlJSLink("term",null,"Vocabulary")+")",o=this.createHtmlExternalLinkLegend(),l=this.createHtmlTypeStructureBreadcrumbs(t,e,r,n);return'<span style="float: right;">'.concat(c,'</span>\n            <h1 property="rdfs:label" class="page-title">').concat(i,"</h1>\n            ").concat(o," ").concat(l,'\n            <div property="rdfs:comment">').concat(s,"<br><br></div>")}createHtmlExternalLinkLegend(){var t="margin-right: 3px; "+this.createExternalLinkStyle(""),e="margin-right: 3px; "+this.createExternalLinkStyle("https://schema.org")+" margin-left: 6px;";return'<p style="font-size: 12px; margin-top: 0">\n            (<span style="'.concat(t,'"></span>External link\n            <span style="').concat(e,'"></span>External link to schema.org)</p>')}createHtmlTypeStructureBreadcrumbs(t,e,r,n){return"<h4>"+t.map(t=>'<span class="breadcrumbs">'+r+t.map((r,a)=>{var i="";return(""===n&&a+2===t.length||""!==n&&a+1===t.length)&&(i+=this.createHtmlSemanticLink(e,r)),i+=this.createLink(r)}).join(" > ")+n+"</span>").join("<br>")+"</h4>"}createHtmlSemanticLink(t,e){var r=this.escHtml(t),n=this.escHtml(this.createHref(e));return'<link property="'.concat(r,'" href="').concat(n,'">')}createHref(t){return this.isTermOfVocab(t)?this.createIriWithQueryParam("term",t):this.browser.sdoAdapter.getTerm(t).getIRI()}isTermOfVocab(t){return this.browser.vocab&&(this.browser.classes.includes(t)||this.browser.properties.includes(t)||this.browser.enumerations.includes(t)||this.browser.enumerationMembers.includes(t)||this.browser.dataTypes.includes(t))}createLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.isTermOfVocab(t)?this.createHtmlJSLink("term",t,null,e):this.createExternalLink(this.createHref(t),t,e)}createPropertyTableRow(t){var e=arguments.length>1&&void 0!==arguments[1]&&arguments[1];return this.createHtmlTableRow("rdf:Property",this.createHref(t),"rdfs:label",this.createLink(t),this.createHtmlPropertySideCols(t,e),"prop-name")}createHtmlPropertySideCols(t,e){var r=this.browser.sdoAdapter.getProperty(t),n=this.createHtmlPropertyRange(r,e),a=r.getDescription()||"";return'<td class="prop-etc">'.concat(n,'</td>\n            <td class="prop-desc" property="rdfs:comment">').concat(a,"</td>")}createHtmlPropertyRange(t,e){var r="";return e||(r=t.getRanges(!1).map(t=>this.createHtmlSemanticLink("rangeIncludes",t)+this.createLink(t)).join("&nbsp; or <br>")),r+t.getDomains(!1).map(t=>this.createHtmlSemanticLink("domainIncludes",t)+(e?this.createLink(t):"")).join(e?"&nbsp; or <br>":"")}createHtmlDefinitionTable(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;Array.isArray(t)||(t=[t]),Array.isArray(e)||(e=[e]);var n=t.map(t=>"<th>"+t+"</th>").join(""),a=e[0].startsWith("<tr")?e.join(""):e.map(t=>"<tr>"+t+"</tr>").join(""),i=this.createHtmlAttr(r);return'<table class="definition-table">\n            <thead><tr>'.concat(n,"</tr></thead>\n            <tbody ").concat(i,">").concat(a,"</tbody></table>")}createHtmlRangesOf(){var t=arguments.length>0&&void 0!==arguments[0]&&arguments[0],e=this.browser.term.isRangeOf(!1);if(0===e.length)return"";var r=e.map(t=>this.createPropertyTableRow(t,!0)),n=this.createLink(this.browser.term.getIRI(!0)),a=t?"and its enumeration members or subtypes ":"",i=this.createHtmlDefinitionTable(["Property","On Types","Description"],r);return'<div id="incoming">Instances of '.concat(n," ").concat(a,"may appear as a value for the following properties\n            </div><br>").concat(i)}}module.exports=Util;

},{}],85:[function(require,module,exports){
"use strict";var TYPES_PLURAL={Class:"Classes",Property:"Properties",Enumeration:"Enumerations","Enumeration Member":"Enumeration Members","Data Type":"Data Types"};class VocabRenderer{constructor(e){this.browser=e,this.util=this.browser.util}renderJsonld(){this.browser.targetElement.innerHTML='<pre style="font-size: medium; background: none; text-align: left; width: auto; padding: 0; overflow: visible; color: rgb(0, 0, 0); line-height: normal; display: block; font-family: monospace; margin: 1em 0; word-wrap: break-word; white-space: pre-wrap;">'+JSON.stringify(this.browser.vocab,null,2)+"</pre>"}render(){var e=this.createHeading()+this.createNamespaces()+this.createContentSection()+this.createSection(this.browser.classes,"Class")+this.createSection(this.browser.properties,"Property")+this.createSection(this.browser.enumerations,"Enumeration")+this.createSection(this.browser.enumerationMembers,"Enumeration Member")+this.createSection(this.browser.dataTypes,"Data Type");this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("schema:DataSet",e)}createHeading(){return'<span style="float: right;">('+this.util.createHtmlJSLink("format","jsonld","JSON-LD serialization")+(this.browser.list?" | from List: "+this.util.createHtmlJSLink("voc",null,this.browser.list["schema:name"]):"")+")</span><h1>"+(this.browser.vocName?this.browser.vocName:"Vocabulary")+"</h1>"+this.util.createHtmlExternalLinkLegend()}createNamespaces(){return'<h2 style="margin: revert;">Namespaces</h2><ul>'+Object.entries(this.browser.namespaces).map(e=>"<li>"+e[0]+": "+this.util.createExternalLink(e[1])+"</li>").join("")+"</ul>"}createContentSection(){return'<h2 style="margin: revert;">Content</h2><ul>'+this.createContentListElement(this.browser.classes,"Class")+this.createContentListElement(this.browser.properties,"Property")+this.createContentListElement(this.browser.enumerations,"Enumeration")+this.createContentListElement(this.browser.enumerationMembers,"Enumeration Member")+this.createContentListElement(this.browser.dataTypes,"Data Type")+"</ul>"}createContentListElement(e,t){if(0!==e.length){var r=TYPES_PLURAL[t];return'<li><a href="#'+this.util.underscore(r)+'">'+e.length+" "+(1===e.length?t:r)+"</a></li>"}return""}createSection(e,t){if(0!==e.length){var r=TYPES_PLURAL[t];return'<h2 id="'+this.util.underscore(r)+'">'+r+"</h2>"+this.util.createHtmlDefinitionTable([t,"Description"],this.createSectionTbody(e),{class:"supertype"})}return""}createSectionTbody(e){return e.map(e=>{var t=this.browser.sdoAdapter.getTerm(e);return this.util.createHtmlTableRow(t.getTermType(),this.util.createIriWithQueryParam("term",e),"@id",this.util.createHtmlJSLink("term",e),'<td property="rdfs:comment">'+(t.getDescription()||"")+"</td>")}).join("")}}module.exports=VocabRenderer;
