...
"use strict";function asyncGeneratorStep(e,t,r,a,s,n,i){try{var o=e[n](i),c=o.value}catch(e){return void r(e)}o.done?t(c):Promise.resolve(c).then(a,s)}function _asyncToGenerator(e){return function(){var t=this,r=arguments;return new Promise(function(a,s){var n=e.apply(t,r);function i(e){asyncGeneratorStep(n,a,s,i,o,"next",e)}function o(e){asyncGeneratorStep(n,a,s,i,o,"throw",e)}i(void 0)})}}class ListRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.createHeader()+this.createVocabsTable();this.browser.elem.innerHTML=this.util.createMainContent("schema:DataSet",e),this.addEventListener()}createHeader(){return"<h1>"+this.browser.list["schema:name"]+"</h1>"}createVocabsTable(){return'<table class="definition-table"><thead><tr><th>Name</th><th>IRI</th><th>Author</th><th>Description</th></tr></thead><tbody class="supertype">'+this.createVocabsTbody()+"</tbody></table>"}createVocabsTbody(){return this.browser.list["schema:hasPart"].map((e,t)=>this.util.createTableRow("http://vocab.sti2.at/ds/Vocabulary",this.util.createIRIwithQueryParam("voc",t+1),"schema:name",this.util.createJSLink("a-vocab-name","voc",t+1,e["schema:name"]||""),this.createVocabsSideCols(e))).join("")}createVocabsSideCols(e){return'<td property="@id">'+this.util.createExternalLink(e["@id"])+'</td><td property="schema:author">'+(e["schema:author"]&&e["schema:author"]["schema:name"])||'</td><td property="schema:description">'+e["schema:description"]||"</td>"}addEventListener(){for(var e=this,t=document.getElementsByClassName("a-vocab-name"),r=function(r){t[r].addEventListener("click",_asyncToGenerator(function*(){history.pushState(null,null,e.util.createIRIwithQueryParam("voc",r+1)),yield e.browser.render()}))},a=0;a<t.length;a++)r(a)}}module.exports=ListRenderer;
...
"use strict";function asyncGeneratorStep(e,r,t,a,n,i,s){try{var o=e[i](s),d=o.value}catch(e){return void t(e)}o.done?r(d):Promise.resolve(d).then(a,n)}function _asyncToGenerator(e){return function(){var r=this,t=arguments;return new Promise(function(a,n){var i=e.apply(r,t);function s(e){asyncGeneratorStep(i,a,n,s,o,"next",e)}function o(e){asyncGeneratorStep(i,a,n,s,o,"throw",e)}s(void 0)})}}var SDOAdapter=_dereq_("schema-org-adapter"),Util=_dereq_("./Util"),ListRenderer=_dereq_("./ListRenderer"),VocabRenderer=_dereq_("./VocabRenderer"),ClassRenderer=_dereq_("./ClassRenderer"),PropertyRenderer=_dereq_("./PropertyRenderer"),EnumerationRenderer=_dereq_("./EnumerationRenderer"),EnumerationMemberRenderer=_dereq_("./EnumerationMemberRenderer"),DataTypeRenderer=_dereq_("./DataTypeRenderer"),TYPES={VOCAB:"VOCAB",LIST:"LIST"};class SDOVocabBrowser{constructor(e,r){var t=this,a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:TYPES.VOCAB;this.elem=e,this.vocabOrVocabList=r,this.type=a,this.util=new Util(this),this.listRenderer=new ListRenderer(this),this.vocabRenderer=new VocabRenderer(this),this.classRenderer=new ClassRenderer(this),this.propertyRenderer=new PropertyRenderer(this),this.enumerationRenderer=new EnumerationRenderer(this),this.enumerationMemberRenderer=new EnumerationMemberRenderer(this),this.dataTypeRenderer=new DataTypeRenderer(this),window.addEventListener("popstate",_asyncToGenerator(function*(){yield t.render()}))}render(){var e=this;return _asyncToGenerator(function*(){yield e.init(),e.isListRendering()?e.listRenderer.render():e.isVocabRendering()?e.vocabRenderer.render():e.isTermRendering()&&e.renderTerm(),document.body.scrollTop=document.documentElement.scrollTop=0})()}init(){var e=this;return _asyncToGenerator(function*(){e.listNeedsInit()&&(yield e.initList()),e.vocabNeedsInit()&&(yield e.initVocab())})()}listNeedsInit(){return this.type===TYPES.LIST&&!this.list}initList(){var e=this;return _asyncToGenerator(function*(){var r;e.util.isString(e.vocabOrVocabList)?(r=e.util.isValidUrl(e.vocabOrVocabList)?yield e.util.get(e.vocabOrVocabList):e.vocabOrVocabList,e.list=JSON.parse(r)):e.list=e.vocabOrVocabList})()}vocabNeedsInit(){var e=new URLSearchParams(window.location.search).get("voc");return this.type===TYPES.LIST&&e&&e!==this.listNumber||this.type===TYPES.VOCAB&&!this.vocabs}initVocab(){var e=this;return _asyncToGenerator(function*(){var r;if(e.type===TYPES.VOCAB)r=e.vocabOrVocabList;else if(e.type===TYPES.LIST){var t=new URLSearchParams(window.location.search);e.listNumber=t.get("voc"),r=e.list["schema:hasPart"][e.listNumber-1]["@id"]}e.sdoAdapter=new SDOAdapter;var a=yield e.sdoAdapter.constructSDOVocabularyURL("latest","all-layers");yield e.sdoAdapter.addVocabularies([a,r]),e.vocabs=e.sdoAdapter.getVocabularies(r),delete e.vocabs.schema;var n=Object.keys(e.vocabs);e.classes=e.sdoAdapter.getListOfClasses({fromVocabulary:n}),e.properties=e.sdoAdapter.getListOfProperties({fromVocabulary:n}),e.enumerations=e.sdoAdapter.getListOfEnumerations({fromVocabulary:n}),e.enumerationMembers=e.sdoAdapter.getListOfEnumerationMembers({fromVocabulary:n}),e.dataTypes=e.sdoAdapter.getListOfDataTypes({fromVocabulary:n})})()}isListRendering(){var e=new URLSearchParams(window.location.search);return this.type===TYPES.LIST&&!e.get("voc")}isVocabRendering(){var e=new URLSearchParams(window.location.search);return this.type===TYPES.LIST&&e.get("voc")&&!e.get("term")||this.type===TYPES.VOCAB&&!e.get("term")}isTermRendering(){return new URLSearchParams(window.location.search).get("term")}renderTerm(){var e=new URLSearchParams(window.location.search);switch(this.term=this.sdoAdapter.getTerm(e.get("term")),this.term.getTermType()){case"rdfs:Class":this.classRenderer.render();break;case"rdf:Property":this.propertyRenderer.render();break;case"schema:Enumeration":this.enumerationRenderer.render();break;case"soa:EnumerationMember":this.enumerationMemberRenderer.render();break;case"schema:DataType":this.dataTypeRenderer.render()}this.util.addTermEventListener()}}module.exports=SDOVocabBrowser;
...
"use strict";function asyncGeneratorStep(e,t,r,n,a,s,i){try{var o=e[s](i),c=o.value}catch(e){return void r(e)}o.done?t(c):Promise.resolve(c).then(n,a)}function _asyncToGenerator(e){return function(){var t=this,r=arguments;return new Promise(function(n,a){var s=e.apply(t,r);function i(e){asyncGeneratorStep(s,n,a,i,o,"next",e)}function o(e){asyncGeneratorStep(s,n,a,i,o,"throw",e)}i(void 0)})}}class Util{constructor(e){this.browser=e}isString(e){return"string"==typeof e||e instanceof String}isValidUrl(e){try{new URL(e)}catch(e){return!1}return!0}get(e){return new Promise(function(t,r){var n=new XMLHttpRequest;n.open("GET",e),n.onload=function(){this.status>=200&&this.status<300?t(n.response):r({status:this.status,statusText:n.statusText})},n.onerror=function(){r({status:this.status,statusText:n.statusText})},n.send()})}addTermEventListener(){var e=this,t=document.getElementsByClassName("a-term-name"),r=function(t){t.addEventListener("click",_asyncToGenerator(function*(){history.pushState(null,null,e.createIRIwithQueryParam("term",t.innerText)),yield e.browser.render()}))};for(var n of t)r(n)}createIRIwithQueryParam(e,t){var r=new URLSearchParams(window.location.search);return r.set(e,t),window.location.origin+window.location.pathname+"?"+r.toString()}createTableRow(e,t,r,n,a){var s=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null;return'<tr typeof="'+e+'" resource="'+t+'">'+this.createMainColEntry(r,n,s)+a+"</tr>"}createMainColEntry(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return"<th"+(r?' class="'+r+'"':"")+' scope="row">'+this.createCodeLink(t,{property:e})+"</th>"}createCodeLink(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;return"<code"+this.createHTMLAttr(t)+">"+this.createFullLink(e,r,n)+"</code>"}createFullLink(e,t,r){var n=null;try{n=this.browser.sdoAdapter.getTerm(e)}catch(e){}return""+(r?this.createSemanticLink(r,e):"")+(n?this.createLink(e,t):e)}createJSLink(e,t,r){var n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null;return"<a "+this.createAttrForJSLink(e,t,r,a)+">"+(n?this.escHTML(n):this.escHTML(r))+"</a>"}createAttrForJSLink(e,t,r){var n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,a=this.createIRIwithQueryParam(t,r);return'class="'+this.escHTML(e)+'" href="'+this.escHTML(a)+'" onclick="return false;"'+this.createHTMLAttr(n)}escHTML(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}createHTMLAttr(e){return e?Object.entries(e).map(e=>" "+this.escHTML(e[0])+'="'+this.escHTML(e[1])+'"').join(""):""}createExternalLink(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return'<a href="'+this.escHTML(e)+'" target="_blank"'+this.createHTMLAttr(r)+">"+(t?this.prettyPrintURI(t):this.prettyPrintURI(e))+"</a>"}prettyPrintURI(e){return e.startsWith("schema:")?e.substring("schema:".length):this.escHTML(e)}createMainContent(e,t){return'<div id="mainContent" vocab="http://schema.org/" typeof="'+e+'" resource="'+window.location+'">'+t+"</div>"}underscore(e){return e.replace(/ /g,"_")}getTypeStructures(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"getSuperClasses",r=e[t](!1);if(0===r.length)return[[e.getIRI(!0)]];var n=[];return r.forEach(r=>{var a=this.browser.sdoAdapter.getTerm(r);this.getTypeStructures(a,t).forEach(t=>{t.push(e.getIRI(!0)),n.push(t)})}),n}createHeader(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"",n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"",a=this.browser.term;return'<h1 property="rdfs:label" class="page-title">'+a.getIRI(!0)+"</h1>"+this.createSuperTypeBreadcrumbs(e,t,r,n)+'</h4><div property="rdfs:comment">'+a.getDescription()+"<br><br></div>"}createSuperTypeBreadcrumbs(e,t,r,n){return e?"<h4>"+e.map(e=>'<span class="breadcrumbs">'+r+e.map((r,a)=>{var s="";return(""===n&&a+2===e.length||""!==n&&a+1===e.length)&&(s+=this.createSemanticLink(t,r)),s+=this.createLink(r)}).join(" > ")+n+"</span>").join("<br>")+"</h4>":""}createSemanticLink(e,t){return'<link property="'+this.escHTML(e)+'" href="'+this.escHTML(this.createHref(t))+'">'}createHref(e){return this.isTermOfVocab(e)?this.createIRIwithQueryParam("term",e):this.browser.sdoAdapter.getTerm(e).getIRI()}isTermOfVocab(e){return this.browser.vocabs&&(this.browser.classes.includes(e)||this.browser.properties.includes(e)||this.browser.enumerations.includes(e)||this.browser.enumerationMembers.includes(e)||this.browser.dataTypes.includes(e))}createLink(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.isTermOfVocab(e)?this.createJSLink("a-term-name","term",e,null,t):this.createExternalLink(this.createHref(e),e,t)}createPropertyTableRow(e){var t=arguments.length>1&&void 0!==arguments[1]&&arguments[1];return this.createTableRow("rdfs:Property",this.createHref(e),"rdfs:label",this.createLink(e),this.createPropertySideCols(e,t),"prop-name")}createPropertySideCols(e,t){var r=this.browser.sdoAdapter.getProperty(e);return'<td class="prop-etc">'+this.createPropertyRange(r,t)+'</td><td class="prop-desc" property="rdfs:comment">'+r.getDescription()+"</td>"}createPropertyRange(e,t){var r="";return t||(r=e.getRanges(!1).map(e=>this.createSemanticLink("rangeIncludes",e)+this.createLink(e)).join("&nbsp; or <br>")),r+e.getDomains(!1).map(e=>this.createSemanticLink("domainIncludes",e)+(t?this.createLink(e):"")).join(t?"&nbsp; or <br>":"")}createDefinitionTable(e,t){return Array.isArray(e)||(e=[e]),Array.isArray(t)||(t=[t]),'<table class="definition-table"><thead><tr>'+e.map(e=>"<th>"+e+"</th>").join("")+"</tr></thead><tbody>"+(t[0].startsWith("<tr")?t.join(""):t.map(e=>"<tr>"+e+"</tr>").join(""))+"</tbody></table>"}createRangesOf(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],t=this.browser.term.isRangeOf(!1);if(0!==t.length){var r=t.map(e=>this.createPropertyTableRow(e,!0));return'<div id="incoming">Instances of '+this.createLink(this.browser.term.getIRI(!0))+(e?" and its enumeration members or subtypes":"")+" may appear as a value for the following properties</div><br>"+this.createDefinitionTable(["Property","On Types","Description"],r)}return""}}module.exports=Util;

},{}],91:[function(_dereq_,module,exports){
"use strict";var TYPES_PLURAL={Class:"Classes",Property:"Properties",Enumeration:"Enumerations","Enumeration Member":"Enumeration Members","Data Type":"Data Types"};class VocabRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.createHeading()+this.createContentSection()+this.createSection(this.browser.classes,"Class")+this.createSection(this.browser.properties,"Property")+this.createSection(this.browser.enumerations,"Enumeration")+this.createSection(this.browser.enumerationMembers,"Enumeration Member")+this.createSection(this.browser.dataTypes,"Data Type");this.browser.elem.innerHTML=this.util.createMainContent("schema:DataSet",e),this.util.addTermEventListener()}createHeading(){return"<h1>"+Object.entries(this.browser.vocabs).map(e=>e[0]+":"+e[1])+"</h1>"}createContentSection(){return"<h2>Content</h2><ul>"+this.createContentListElement(this.browser.classes,"Class")+this.createContentListElement(this.browser.properties,"Property")+this.createContentListElement(this.browser.enumerations,"Enumeration")+this.createContentListElement(this.browser.enumerationMembers,"Enumeration Member")+this.createContentListElement(this.browser.dataTypes,"Data Type")+"</ul>"}createContentListElement(e,t){if(0!==e.length){var r=TYPES_PLURAL[t];return'<li><a href="#'+this.util.underscore(r)+'">'+e.length+" "+(1===e.length?t:r)+"</a></li>"}return""}createSection(e,t){if(0!==e.length){var r=TYPES_PLURAL[t];return'<h2 id="'+this.util.underscore(r)+'">'+r+'</h2><table class="definition-table"><thead><tr><th>'+t+'</th><th>Description</th></tr></thead><tbody class="supertype">'+this.createSectionTbody(e)+"</tbody></table>"}return""}createSectionTbody(e){return e.map(e=>{var t=this.browser.sdoAdapter.getTerm(e);return this.util.createTableRow(t.getTermType(),this.util.createIRIwithQueryParam("term",e),"@id",this.util.createJSLink("a-term-name","term",e),'<td property="rdfs:comment">'+t.getDescription()+"</td>")}).join("")}}module.exports=VocabRenderer;
