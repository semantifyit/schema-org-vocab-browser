...
"use strict";require("setimmediate");const crypto=self.crypto||self.msCrypto;module.exports=class{constructor(t){if(!crypto||!crypto.subtle)throw new Error("crypto.subtle not found.");if("sha256"===t)this.algorithm={name:"SHA-256"};else{if("sha1"!==t)throw new Error(`Unsupport algorithm "${t}".`);this.algorithm={name:"SHA-1"}}this._content=""}update(t){this._content+=t}async digest(){const t=(new TextEncoder).encode(this._content),e=new Uint8Array(await crypto.subtle.digest(this.algorithm,t));let r="";for(let t=0;t<e.length;++t)r+=e[t].toString(16).padStart(2,"0");return r}};
...
"use strict";var util=require("./utilities"),Term=require("./Term");class Class extends Term{constructor(s,e){super(s,e)}getTermType(){return"rdfs:Class"}getTermObj(){return this.graph.classes[this.IRI]}getProperties(){var s=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.getTermObj(),t=[];return t.push(...r["soa:hasProperty"]),s&&t.push(...this.graph.reasoner.inferPropertiesFromSuperClasses(r["rdfs:subClassOf"])),util.applyFilter(util.uniquifyArray(t),e,this.graph)}getSuperClasses(){var s=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.getTermObj(),t=[];return s?t.push(...this.graph.reasoner.inferSuperClasses(this.IRI)):t.push(...r["rdfs:subClassOf"]),util.applyFilter(util.uniquifyArray(t),e,this.graph)}getSubClasses(){var s=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.getTermObj(),t=[];return s?t.push(...this.graph.reasoner.inferSubClasses(this.IRI)):t.push(...r["soa:superClassOf"]),util.applyFilter(util.uniquifyArray(t),e,this.graph)}isRangeOf(){var s=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=[];return s?r.push(...this.graph.reasoner.inferRangeOf(this.IRI)):r.push(...this.getTermObj()["soa:isRangeOf"]),util.applyFilter(util.uniquifyArray(r),e,this.graph)}toJSON(){var s=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=super.toJSON();return r.superClasses=this.getSuperClasses(s,e),r.subClasses=this.getSubClasses(s,e),r.properties=this.getProperties(s,e),r.rangeOf=this.isRangeOf(s,e),r}}module.exports=Class;

},{"./Term":72,"./utilities":73}],65:[function(require,module,exports){
"use strict";var util=require("./utilities"),Term=require("./Term");class DataType extends Term{constructor(e,t){super(e,t)}getTermType(){return"schema:DataType"}getTermObj(){return this.graph.dataTypes[this.IRI]}getSuperDataTypes(){var e=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.getTermObj(),s=[];return e?s.push(...this.graph.reasoner.inferSuperDataTypes(this.IRI)):s.push(...r["rdfs:subClassOf"]),util.applyFilter(util.uniquifyArray(s),t,this.graph)}getSubDataTypes(){var e=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.getTermObj(),s=[];return e?s.push(...this.graph.reasoner.inferSubDataTypes(this.IRI)):s.push(...r["soa:superClassOf"]),util.applyFilter(util.uniquifyArray(s),t,this.graph)}isRangeOf(){var e=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=[];return e?r.push(...this.graph.reasoner.inferRangeOf(this.IRI)):r.push(...this.getTermObj()["soa:isRangeOf"]),util.applyFilter(util.uniquifyArray(r),t,this.graph)}toJSON(){var e=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=super.toJSON();return r.superDataTypes=this.getSuperDataTypes(e,t),r.subDataTypes=this.getSubDataTypes(e,t),r.rangeOf=this.isRangeOf(e,t),r}}module.exports=DataType;

},{"./Term":72,"./utilities":73}],66:[function(require,module,exports){
"use strict";var util=require("./utilities"),Class=require("./Class");class Enumeration extends Class{constructor(e,r){super(e,r)}getTermType(){return"schema:Enumeration"}getTermObj(){return this.graph.enumerations[this.IRI]}getEnumerationMembers(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=[];if(t.push(...this.getTermObj()["soa:hasEnumerationMember"]),e){var s=this.getSubClasses(!0,null);for(var i of s){var n=this.graph.enumerations[i];util.isNil(n)||t.push(...n["soa:hasEnumerationMember"])}}return util.applyFilter(util.uniquifyArray(t),r,this.graph)}toJSON(){var e=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=super.toJSON(e,r);return t.enumerationMembers=this.getEnumerationMembers(e,r),t}}module.exports=Enumeration;

},{"./Class":64,"./utilities":73}],67:[function(require,module,exports){
"use strict";var util=require("./utilities"),Term=require("./Term");class EnumerationMember extends Term{constructor(e,r){super(e,r)}getTermType(){return"soa:EnumerationMember"}getTermObj(){return this.graph.enumerationMembers[this.IRI]}getDomainEnumerations(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=this.getTermObj(),i=[];if(i.push(...t["soa:enumerationDomainIncludes"]),e){var n=util.copByVal(i);for(var u of n)i.push(...this.graph.reasoner.inferSuperClasses(u));i=util.applyFilter(util.uniquifyArray(i),{termType:"Enumeration"},this.graph)}return util.applyFilter(util.uniquifyArray(i),r,this.graph)}toJSON(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=super.toJSON();return t.domainEnumerations=this.getDomainEnumerations(e,r),t}}module.exports=EnumerationMember;

},{"./Term":72,"./utilities":73}],68:[function(require,module,exports){
"use strict";function asyncGeneratorStep(e,s,r,a,t,o,i){try{var n=e[o](i),u=n.value}catch(e){return void r(e)}n.done?s(u):Promise.resolve(u).then(a,t)}function _asyncToGenerator(e){return function(){var s=this,r=arguments;return new Promise(function(a,t){var o=e.apply(s,r);function i(e){asyncGeneratorStep(o,a,t,i,n,"next",e)}function n(e){asyncGeneratorStep(o,a,t,i,n,"throw",e)}i(void 0)})}}var util=require("./utilities"),Class=require("./Class"),Property=require("./Property"),Enumeration=require("./Enumeration"),EnumerationMember=require("./EnumerationMember"),DataType=require("./DataType"),ReasoningEngine=require("./ReasoningEngine");class Graph{constructor(e){this.sdoAdapter=e,this.reasoner=new ReasoningEngine(this),this.context={rdf:"http://www.w3.org/1999/02/22-rdf-syntax-ns#",rdfs:"http://www.w3.org/2000/01/rdf-schema#",xsd:"http://www.w3.org/2001/XMLSchema#",dc:"http://purl.org/dc/terms/",soa:"http://schema-org-adapter.at/vocabTerms/","soa:superClassOf":{"@id":"soa:superClassOf","@type":"@id"},"soa:superPropertyOf":{"@id":"soa:superPropertyOf","@type":"@id"},"soa:hasProperty":{"@id":"soa:hasProperty","@type":"@id"},"soa:isRangeOf":{"@id":"soa:isRangeOf","@type":"@id"},"soa:hasEnumerationMember":{"@id":"soa:hasEnumerationMember","@type":"@id"},"soa:enumerationDomainIncludes":{"@id":"soa:enumerationDomainIncludes","@type":"@id"},"rdfs:subClassOf":{"@id":"rdfs:subClassOf","@type":"@id"},"rdfs:subPropertyOf":{"@id":"rdfs:subPropertyOf","@type":"@id"},"schema:isPartOf":{"@id":"schema:isPartOf","@type":"@id"},"schema:domainIncludes":{"@id":"schema:domainIncludes","@type":"@id"},"schema:rangeIncludes":{"@id":"schema:rangeIncludes","@type":"@id"},"schema:supersededBy":{"@id":"schema:supersededBy","@type":"@id"},"schema:inverseOf":{"@id":"schema:inverseOf","@type":"@id"},"dc:source":{"@id":"dc:source","@type":"@id"},"schema:source":{"@id":"schema:source","@type":"@id"}},this.classes={},this.properties={},this.dataTypes={},this.enumerations={},this.enumerationMembers={}}addVocabulary(e){var s=arguments,r=this;return _asyncToGenerator(function*(){var a=s.length>1&&void 0!==s[1]?s[1]:null;void 0===r.context.schema&&(r.context.schema=util.discoverUsedSchemaOrgProtocol(e)+"://schema.org/");try{if(r.sdoAdapter.equateVocabularyProtocols){var t=util.discoverEquateNamespaces(r.context,e);if(t.length>0){var o=util.copByVal(e["@context"]);t.forEach(function(e){var s=Object.keys(o).find(s=>o[s]===e);s&&delete o[s];var r=Object.keys(this.context).find(s=>this.context[s]===util.switchIRIProtocol(e));o[r]=e},r),e=yield util.preProcessVocab(e,o),t.forEach(function(s){var r=Object.keys(this.context).find(e=>this.context[e]===util.switchIRIProtocol(s));e["@context"][r]=this.context[r]},r)}}r.context=util.generateContext(r.context,e["@context"]),e=yield util.preProcessVocab(e,r.context);var i,n,u=r.sdoAdapter.getVocabularies();for(var l of e["@graph"])l=util.curateVocabNode(l,u);for(var c=0;c<e["@graph"].length;c++){var f=util.copByVal(e["@graph"][c]);if(util.isString(f["@type"]))switch(f["@type"]){case"rdfs:Class":r.addGraphNode(r.classes,f,a);break;case"rdf:Property":r.addGraphNode(r.properties,f,a);break;default:r.addGraphNode(r.enumerationMembers,f,a)}else util.isArray(f["@type"])?f["@type"].includes("rdfs:Class")&&f["@type"].includes("schema:DataType")?r.addGraphNode(r.dataTypes,f,a):r.addGraphNode(r.enumerationMembers,f,a):r.sdoAdapter.onError("unexpected @type format for the following node: "+JSON.stringify(f,null,2))}do{i=!1;var h=Object.keys(r.classes),d=Object.keys(r.enumerations);for(var p of h)if(void 0!==r.classes[p]["rdfs:subClassOf"]){var m=r.classes[p]["rdfs:subClassOf"];for(var y of m)("schema:Enumeration"===y||d.includes(y))&&r.classes[p]&&!r.enumerations[p]&&(i=!0,r.enumerations[p]=util.copByVal(r.classes[p]),delete r.classes[p])}}while(i);do{n=!1;var v=Object.keys(r.classes),b=Object.keys(r.dataTypes);for(var O of v)if(void 0!==r.classes[O]["rdfs:subClassOf"]){var g=r.classes[O]["rdfs:subClassOf"];for(var w of g)("schema:DataType"===w||b.includes(w))&&r.classes[O]&&!r.dataTypes[O]&&(n=!0,r.dataTypes[O]=util.copByVal(r.classes[O]),delete r.classes[O])}}while(n);var I=Object.keys(r.dataTypes);for(var P of I)r.dataTypes[P]["@type"]="schema:DataType";var C=Object.keys(r.classes);for(var E of C){var T=r.classes[E]["rdfs:subClassOf"];for(var R of(r.classes[E]["soa:superClassOf"]||(r.classes[E]["soa:superClassOf"]=[]),T)){var k=r.classes[R];k||(k=r.enumerations[R]),k&&(k["soa:superClassOf"]?k["soa:superClassOf"].includes(E)||k["soa:superClassOf"].push(E):k["soa:superClassOf"]=[E])}}var M=Object.keys(r.enumerations);for(var j of M){var N=r.enumerations[j]["rdfs:subClassOf"];for(var x of(r.enumerations[j]["soa:superClassOf"]||(r.enumerations[j]["soa:superClassOf"]=[]),N)){var D=r.classes[x];D||(D=r.enumerations[x]),D&&(D["soa:superClassOf"]?D["soa:superClassOf"].includes(j)||D["soa:superClassOf"].push(j):D["soa:superClassOf"]=[j])}}var A=Object.keys(r.dataTypes);for(var G of A){var L=r.dataTypes[G]["rdfs:subClassOf"];if(r.dataTypes[G]["soa:superClassOf"]||(r.dataTypes[G]["soa:superClassOf"]=[]),L)for(var V of L){var q=r.dataTypes[V];q&&(q["soa:superClassOf"]?q["soa:superClassOf"].includes(G)||q["soa:superClassOf"].push(G):q["soa:superClassOf"]=[G])}else r.dataTypes[G]["rdfs:subClassOf"]=[]}var B=Object.keys(r.properties);for(var S of B){var U=r.properties[S]["rdfs:subPropertyOf"];if(r.properties[S]["soa:superPropertyOf"]||(r.properties[S]["soa:superPropertyOf"]=[]),U)for(var F of U){var W=r.properties[F];W&&(W["soa:superPropertyOf"]?W["soa:superPropertyOf"].includes(S)||W["soa:superPropertyOf"].push(S):W["soa:superPropertyOf"]=[S])}else r.properties[S]["rdfs:subPropertyOf"]=[]}for(var _ of C=Object.keys(r.classes))r.classes[_]["soa:hasProperty"]||(r.classes[_]["soa:hasProperty"]=[]),r.classes[_]["soa:isRangeOf"]||(r.classes[_]["soa:isRangeOf"]=[]);for(var J of M=Object.keys(r.enumerations))r.enumerations[J]["soa:hasEnumerationMember"]||(r.enumerations[J]["soa:hasEnumerationMember"]=[]),r.enumerations[J]["soa:isRangeOf"]||(r.enumerations[J]["soa:isRangeOf"]=[]),r.enumerations[J]["soa:hasProperty"]||(r.enumerations[J]["soa:hasProperty"]=[]);for(var X of A=Object.keys(r.dataTypes))r.dataTypes[X]["soa:isRangeOf"]||(r.dataTypes[X]["soa:isRangeOf"]=[]);var z=Object.keys(r.enumerationMembers);for(var H of z)r.enumerationMembers[H]["soa:enumerationDomainIncludes"]||(r.enumerationMembers[H]["soa:enumerationDomainIncludes"]=[]);for(var K of B=Object.keys(r.properties)){var Q=r.properties[K]["schema:domainIncludes"];if(util.isArray(Q))for(var Y of Q){var Z=r.classes[Y];Z||(Z=r.enumerations[Y]),Z&&util.isArray(Z["soa:hasProperty"])&&!Z["soa:hasProperty"].includes(K)&&Z["soa:hasProperty"].push(K)}var $=r.properties[K]["schema:rangeIncludes"];if(util.isArray($))for(var ee of $){var se=r.classes[ee]||r.enumerations[ee]||r.dataTypes[ee];se&&util.isArray(se["soa:isRangeOf"])&&!se["soa:isRangeOf"].includes(K)&&se["soa:isRangeOf"].push(K)}}for(var re of z=Object.keys(r.enumerationMembers)){var ae=r.enumerationMembers[re],te=ae["@type"];for(var oe of(util.isArray(te)||(te=[te]),te)){var ie=r.enumerations[oe];ie&&util.isArray(ie["soa:hasEnumerationMember"])&&!ie["soa:hasEnumerationMember"].includes(re)&&(ie["soa:hasEnumerationMember"].push(re),util.isArray(ae["soa:enumerationDomainIncludes"])?ae["soa:enumerationDomainIncludes"].push(oe):ae["soa:enumerationDomainIncludes"]=[oe])}}return!0}catch(e){return r.sdoAdapter.onError(e),!1}})()}addGraphNode(e,s){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;try{if(e[s["@id"]]){var a=e[s["@id"]];if(util.isNil(s["schema:isPartOf"])||(a["schema:isPartOf"]=s["schema:isPartOf"]),util.isNil(s["dc:source"])||(a["dc:source"]=s["dc:source"]),util.isNil(s["schema:source"])||(a["schema:source"]=s["schema:source"]),util.isNil(s["schema:category"])||(a["schema:category"]=s["schema:category"]),util.isNil(s["schema:supersededBy"])||(a["schema:supersededBy"]=s["schema:supersededBy"]),!util.isNil(s["rdfs:label"])){var t=Object.keys(s["rdfs:label"]);for(var o of t)a["rdfs:label"][o]=s["rdfs:label"][o]}if(!util.isNil(s["rdfs:comment"])){var i=Object.keys(s["rdfs:comment"]);for(var n of i)a["rdfs:comment"][n]=s["rdfs:comment"][n]}if(!util.isNil(s["rdfs:subClassOf"]))for(var u of s["rdfs:subClassOf"])a["rdfs:subClassOf"].includes(u)||a["rdfs:subClassOf"].push(u);if(!util.isNil(s["soa:superClassOf"]))for(var l of s["soa:superClassOf"])a["soa:superClassOf"].includes(l)||a["soa:superClassOf"].push(l);if(!util.isNil(s["soa:hasProperty"]))for(var c of s["soa:hasProperty"])a["soa:hasProperty"].includes(c)||a["soa:hasProperty"].push(c);if(!util.isNil(s["soa:isRangeOf"]))for(var f of s["soa:isRangeOf"])a["soa:isRangeOf"].includes(f)||a["soa:isRangeOf"].push(f);if(!util.isNil(s["soa:enumerationDomainIncludes"]))for(var h of s["soa:enumerationDomainIncludes"])a["soa:enumerationDomainIncludes"].includes(h)||a["soa:enumerationDomainIncludes"].push(h);if(!util.isNil(s["soa:hasEnumerationMember"]))for(var d of s["soa:hasEnumerationMember"])a["soa:hasEnumerationMember"].includes(d)||a["soa:hasEnumerationMember"].push(d);if(!util.isNil(s["rdfs:subPropertyOf"]))for(var p of s["rdfs:subPropertyOf"])a["rdfs:subPropertyOf"].includes(p)||a["rdfs:subPropertyOf"].push(p);if(!util.isNil(s["schema:domainIncludes"]))for(var m of s["schema:domainIncludes"])a["schema:domainIncludes"].includes(m)||a["schema:domainIncludes"].push(m);if(!util.isNil(s["schema:rangeIncludes"]))for(var y of s["schema:rangeIncludes"])a["schema:rangeIncludes"].includes(y)||a["schema:rangeIncludes"].push(y);if(!util.isNil(s["schema:superPropertyOf"]))for(var v of s["schema:superPropertyOf"])a["schema:superPropertyOf"].includes(v)||a["schema:superPropertyOf"].push(v);r&&(a.vocabURLs?a.vocabURLs.includes(r)||a.vocabURLs.push(r):a.vocabURLs=[r])}else e[s["@id"]]=s,r&&(e[s["@id"]].vocabURLs=[r]);return!0}catch(e){return this.sdoAdapter.onError(e),!1}}getTerm(e){var s,r,a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=this.discoverCompactIRI(e),o=0;do{switch(o){case 0:s=this.classes[t],r="Class";break;case 1:s=this.properties[t],r="Property";break;case 2:s=this.dataTypes[t],r="DataType";break;case 3:s=this.enumerations[t],r="Enumeration";break;case 4:s=this.enumerationMembers[t],r="EnumerationMember"}o++}while(!s&&o<6);if(!s)throw new Error("There is no term with the IRI "+e);if(0===(s=util.applyFilter([s["@id"]],a,this)).length)throw new Error("There is no term with that IRI and filter settings.");switch(r){case"Class":return new Class(t,this);case"Property":return new Property(t,this);case"Enumeration":return new Enumeration(t,this);case"EnumerationMember":return new EnumerationMember(t,this);case"DataType":return new DataType(t,this)}}getClass(e){var s=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.discoverCompactIRI(e);if(r){var a=this.classes[r];if(a){if(0===(a=util.applyFilter([r],s,this)).length)throw new Error("There is no class with that IRI and filter settings.");return new Class(r,this)}if(a=this.enumerations[r])try{return this.getEnumeration(r,s)}catch(e){throw new Error("There is no class with that IRI and filter settings.")}}throw new Error("There is no class with the IRI "+e)}getProperty(e){var s=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.discoverCompactIRI(e);if(r){var a=this.properties[r];if(a){if(0===(a=util.applyFilter([r],s,this)).length)throw new Error("There is no property with that URI and filter settings.");return new Property(r,this)}}throw new Error("There is no property with that URI.")}getDataType(e){var s=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.discoverCompactIRI(e);if(r){var a=this.dataTypes[r];if(a){if(0===(a=util.applyFilter([r],s,this)).length)throw new Error("There is no data-type with that IRI and filter settings.");return new DataType(r,this)}}throw new Error("There is no data-type with the IRI "+e)}getEnumeration(e){var s=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.discoverCompactIRI(e);if(r){var a=this.enumerations[r];if(a){if(0===(a=util.applyFilter([r],s,this)).length)throw new Error("There is no enumeration with that IRI and filter settings.");return new Enumeration(r,this)}}throw new Error("There is no enumeration with the IRI "+e)}getEnumerationMember(e){var s=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.discoverCompactIRI(e);if(r){var a=this.enumerationMembers[r];if(a){if(0===(a=util.applyFilter([r],s,this)).length)throw new Error("There is no EnumerationMember with that IRI and filter settings.");return new EnumerationMember(r,this)}}throw new Error("There is no EnumerationMember with the IRI "+e)}discoverCompactIRI(e){if(e.includes(":")){var s=Object.keys(this.context);for(var r of s){var a=this.context[r];if(util.isString(a)){if(e.startsWith(r))return e;if(e.startsWith(a)||this.sdoAdapter.equateVocabularyProtocols&&e.startsWith(util.switchIRIProtocol(a)))return util.toCompactIRI(e,this.context,this.sdoAdapter.equateVocabularyProtocols)}}}else{var t=Object.keys(this.classes);for(var o of t)if(!0===this.containsLabel(this.classes[o],e))return o;var i=Object.keys(this.properties);for(var n of i)if(!0===this.containsLabel(this.properties[n],e))return n;var u=Object.keys(this.dataTypes);for(var l of u)if(!0===this.containsLabel(this.dataTypes[l],e))return l;var c=Object.keys(this.enumerations);for(var f of c)if(!0===this.containsLabel(this.enumerations[f],e))return f;var h=Object.keys(this.enumerationMembers);for(var d of h)if(!0===this.containsLabel(this.enumerationMembers[d],e))return d}return null}containsLabel(e,s){if(e&&util.isObject(e["rdfs:label"])){var r=Object.keys(e["rdfs:label"]);for(var a of r)if(e["rdfs:label"][a]===s)return!0}return!1}}module.exports=Graph;
...
"use strict";var util=require("./utilities"),Term=require("./Term");class Property extends Term{constructor(r,e){super(r,e)}getTermType(){return"rdf:Property"}getTermObj(){return this.graph.properties[this.IRI]}getRanges(){var r=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=this.getTermObj(),s=[];if(s.push(...t["schema:rangeIncludes"]),r){for(var i of s)s.push(...this.graph.reasoner.inferSubDataTypes(i));for(var u of s)s.push(...this.graph.reasoner.inferSubClasses(u))}return util.applyFilter(util.uniquifyArray(s),e,this.graph)}getDomains(){var r=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=this.getTermObj(),s=[];if(s.push(...t["schema:domainIncludes"]),r){var i=[];for(var u of s)i.push(...this.graph.reasoner.inferSubClasses(u));s.push(...i)}return util.applyFilter(util.uniquifyArray(s),e,this.graph)}getSuperProperties(){var r=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=this.getTermObj(),s=[];return r?s.push(...this.graph.reasoner.inferSuperProperties(this.IRI)):s.push(...t["rdfs:subPropertyOf"]),util.applyFilter(util.uniquifyArray(s),e,this.graph)}getSubProperties(){var r=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=this.getTermObj(),s=[];return r?s.push(...this.graph.reasoner.inferSubProperties(this.IRI)):s.push(...t["soa:superPropertyOf"]),util.applyFilter(util.uniquifyArray(s),e,this.graph)}getInverseOf(){return this.getTermObj()["schema:inverseOf"]}toJSON(){var r=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=super.toJSON();return t.ranges=this.getRanges(r,e),t.domains=this.getDomains(r,e),t.superProperties=this.getSuperProperties(r,e),t.subProperties=this.getSubProperties(r,e),t.inverseOf=this.getInverseOf(),t}}module.exports=Property;

},{"./Term":72,"./utilities":73}],70:[function(require,module,exports){
"use strict";var util=require("./utilities");class ReasoningEngine{constructor(r){this.graph=r}inferPropertiesFromSuperClasses(r){var s=[];for(var a of r){var i=this.graph.classes[a]||this.graph.enumerations[a];i&&(s.push(...i["soa:hasProperty"]),0!==i["rdfs:subClassOf"].length&&s.push(...this.inferPropertiesFromSuperClasses(i["rdfs:subClassOf"])))}return util.uniquifyArray(s)}inferSuperClasses(r){var s=[],a=this.graph.classes[r]||this.graph.enumerations[r];if(a){s.push(...a["rdfs:subClassOf"]);var i=util.copByVal(s);do{var u=[];for(var e of i){var t=this.graph.classes[e]||this.graph.enumerations[e];t&&u.push(...t["rdfs:subClassOf"])}u=util.uniquifyArray(u),i=util.copByVal(u),s.push(...u)}while(0!==i.length);s=util.uniquifyArray(s)}return s}inferSubClasses(r){var s=[],a=this.graph.classes[r]||this.graph.enumerations[r];if(a){s.push(...a["soa:superClassOf"]);var i=util.copByVal(s);do{var u=[];for(var e of i){var t=this.graph.classes[e]||this.graph.enumerations[e];t&&u.push(...t["soa:superClassOf"])}u=util.uniquifyArray(u),i=util.copByVal(u),s.push(...u)}while(0!==i.length);s=util.uniquifyArray(s)}return s}inferSuperDataTypes(r){var s=[],a=this.graph.dataTypes[r];if(a){s.push(...a["rdfs:subClassOf"]);var i=util.copByVal(s);do{var u=[];for(var e of i){var t=this.graph.dataTypes[e];t&&u.push(...t["rdfs:subClassOf"])}u=util.uniquifyArray(u),i=util.copByVal(u),s.push(...u)}while(0!==i.length);s=util.uniquifyArray(s)}return s}inferSubDataTypes(r){var s=[],a=this.graph.dataTypes[r];if(a){s.push(...a["soa:superClassOf"]);var i=util.copByVal(s);do{var u=[];for(var e of i){var t=this.graph.dataTypes[e];t&&u.push(...t["soa:superClassOf"])}u=util.uniquifyArray(u),i=util.copByVal(u),s.push(...u)}while(0!==i.length);s=util.uniquifyArray(s)}return s}inferSuperProperties(r){var s=[],a=this.graph.properties[r];if(a){s.push(...a["rdfs:subPropertyOf"]);var i=util.copByVal(s);do{var u=[];for(var e of i){var t=this.graph.properties[e];t&&u.push(...t["rdfs:subPropertyOf"])}u=util.uniquifyArray(u),i=util.copByVal(u),s.push(...u)}while(0!==i.length);s=util.uniquifyArray(s)}return s}inferSubProperties(r){var s=[],a=this.graph.properties[r];if(a){s.push(...a["soa:superPropertyOf"]);var i=util.copByVal(s);do{var u=[];for(var e of i){var t=this.graph.properties[e];t&&u.push(...t["soa:superPropertyOf"])}u=util.uniquifyArray(u),i=util.copByVal(u),s.push(...u)}while(0!==i.length);s=util.uniquifyArray(s)}return s}inferRangeOf(r){var s=this.graph.classes[r]||this.graph.enumerations[r],a=[];if(s){a.push(...s["soa:isRangeOf"]);var i=this.inferSuperClasses(r);for(var u of i){var e=this.graph.classes[u]||this.graph.enumerations[u];e&&a.push(...e["soa:isRangeOf"])}}else{var t=this.graph.dataTypes[r];if(t){a.push(...t["soa:isRangeOf"]);var p=this.inferSuperDataTypes(r);for(var h of p){var f=this.graph.dataTypes[h];f&&a.push(...f["soa:isRangeOf"])}}}return util.uniquifyArray(a)}}module.exports=ReasoningEngine;

},{"./utilities":73}],71:[function(require,module,exports){
"use strict";function asyncGeneratorStep(e,r,t,a,i,s,o){try{var n=e[s](o),h=n.value}catch(e){return void t(e)}n.done?r(h):Promise.resolve(h).then(a,i)}function _asyncToGenerator(e){return function(){var r=this,t=arguments;return new Promise(function(a,i){var s=e.apply(r,t);function o(e){asyncGeneratorStep(s,a,i,o,n,"next",e)}function n(e){asyncGeneratorStep(s,a,i,o,n,"throw",e)}o(void 0)})}}var Graph=require("./Graph"),util=require("./utilities"),axios=require("axios"),URI_SEMANTIFY_GITHUB="https://raw.githubusercontent.com/semantifyit/schemaorg/main/",URI_SEMANTIFY_RELEASES=URI_SEMANTIFY_GITHUB+"data/releases/",URI_SEMANTIFY_VERSIONS=URI_SEMANTIFY_GITHUB+"versions.json";class SDOAdapter{constructor(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;this.retrievalMemory={versionsFile:null,latest:null},e&&e.commitBase?this.commitBase=e.commitBase:this.commitBase=null,e&&"function"==typeof e.onError?this.onError=e.onError:this.onError=function(){},e&&void 0!==e.schemaHttps?this.schemaHttps=e.schemaHttps:this.schemaHttps=!0,e&&void 0!==e.equateVocabularyProtocols?this.equateVocabularyProtocols=e.equateVocabularyProtocols:this.equateVocabularyProtocols=!1,this.graph=new Graph(this)}addVocabularies(e){var r=this;return _asyncToGenerator(function*(){if(util.isArray(e)||!util.isString(e)&&!util.isObject(e)||(e=[e]),!util.isArray(e))throw new Error("The first argument of the function must be an Array of vocabularies or a single vocabulary (JSON-LD as Object/String)");for(var t of e)if(util.isString(t))if(t.startsWith("www")||t.startsWith("http"))try{var a=yield r.fetchVocabularyFromURL(t);yield r.graph.addVocabulary(a,t)}catch(e){throw new Error("The given URL "+t+" did not contain a valid JSON-LD vocabulary.")}else try{yield r.graph.addVocabulary(JSON.parse(t))}catch(e){throw new Error("Parsing of vocabulary string produced an invalid JSON-LD.")}else{if(!util.isObject(t))throw new Error("The first argument of the function must be an Array of vocabularies or a single vocabulary (JSON-LD as Object/String)");yield r.graph.addVocabulary(t)}})()}fetchVocabularyFromURL(e){return _asyncToGenerator(function*(){return new Promise(function(r,t){axios.get(e,{headers:{Accept:"application/ld+json, application/json"}}).then(function(e){r(e.data)}).catch(function(){t("Could not find any resource at the given URL.")})})})()}getTerm(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getTerm(e,r)}getAllTerms(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[],t=this.getListOfClasses(e),a=this.getListOfEnumerations(e),i=this.getListOfProperties(e),s=this.getListOfDataTypes(e),o=this.getListOfEnumerationMembers(e);for(var n of t)try{r.push(this.getClass(n))}catch(e){throw new Error("There is no class with the IRI "+n)}for(var h of a)try{r.push(this.getEnumeration(h))}catch(e){throw new Error("There is no enumeration with the IRI "+h)}for(var l of i)try{r.push(this.getProperty(l))}catch(e){throw new Error("There is no property with the IRI "+l)}for(var u of s)try{r.push(this.getDataType(u))}catch(e){throw new Error("There is no data type with the IRI "+u)}for(var c of o)try{r.push(this.getEnumerationMember(c))}catch(e){throw new Error("There is no enumeration member with the IRI "+c)}return r}getListOfTerms(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[];return r.push(...Object.keys(this.graph.classes)),r.push(...Object.keys(this.graph.enumerations)),r.push(...Object.keys(this.graph.properties)),r.push(...Object.keys(this.graph.dataTypes)),r.push(...Object.keys(this.graph.enumerationMembers)),util.applyFilter(r,e,this.graph)}getClass(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getClass(e,r)}getAllClasses(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[],t=this.getListOfClasses(e);for(var a of t)try{r.push(this.getClass(a))}catch(e){throw new Error("There is no class with the IRI "+a)}return r}getListOfClasses(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.classes),e,this.graph)}getProperty(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getProperty(e,r)}getAllProperties(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[],t=this.getListOfProperties(e);for(var a of t)try{r.push(this.getProperty(a))}catch(e){throw new Error("There is no property with the IRI "+a)}return r}getListOfProperties(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.properties),e,this.graph)}getDataType(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getDataType(e,r)}getAllDataTypes(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[],t=this.getListOfDataTypes(e);for(var a of t)try{r.push(this.getDataType(a))}catch(e){throw new Error("There is no data type with the IRI "+a)}return r}getListOfDataTypes(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.dataTypes),e,this.graph)}getEnumeration(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getEnumeration(e,r)}getAllEnumerations(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[],t=this.getListOfEnumerations(e);for(var a of t)try{r.push(this.getEnumeration(a))}catch(e){throw new Error("There is no enumeration with the IRI "+a)}return r}getListOfEnumerations(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.enumerations),e,this.graph)}getEnumerationMember(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getEnumerationMember(e,r)}getAllEnumerationMembers(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[],t=this.getListOfEnumerationMembers(e);for(var a of t)try{r.push(this.getEnumerationMember(a))}catch(e){throw new Error("There is no enumeration member with the IRI "+a)}return r}getListOfEnumerationMembers(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.enumerationMembers),e,this.graph)}getVocabularies(){for(var e=Object.keys(this.graph.context),r={},t=["soa","xsd","rdf","rdfa","rdfs","dc"],a=0;a<e.length;a++)util.isString(this.graph.context[e[a]])&&-1===t.indexOf(e[a])&&(r[e[a]]=this.graph.context[e[a]]);return r}constructSDOVocabularyURL(){var e=arguments,r=this;return _asyncToGenerator(function*(){var t=e.length>0&&void 0!==e[0]?e[0]:"latest";if("latest"===t)try{r.retrievalMemory.versionsFile||(yield r.getSDOVersionFile()),t=r.retrievalMemory.latest}catch(e){throw console.error("Could not determine/retrieve the latest version of schema.org"),e}var a=util.getFileNameForSchemaOrgVersion(t,r.schemaHttps);return r.getReleasesURI()+t+"/"+a})()}getSDOVersionFile(){var e=this;return _asyncToGenerator(function*(){var r;try{r=yield axios.get(e.getVersionFileURI())}catch(r){throw e.onError("Unable to retrieve the schema.org versions file at "+e.getVersionFileURI()),r}if(r&&r.data){if(e.retrievalMemory.versionsFile=r.data,e.retrievalMemory.versionsFile.schemaversion){if(yield e.checkURL(yield e.constructSDOVocabularyURL(e.retrievalMemory.versionsFile.schemaversion)))e.retrievalMemory.latest=e.retrievalMemory.versionsFile.schemaversion;else{if(e.retrievalMemory.versionsFile.releaseLog){var t=util.sortReleaseEntriesByDate(e.retrievalMemory.versionsFile.releaseLog);for(var a of t)if(yield e.checkURL(yield e.constructSDOVocabularyURL(a[0]))){e.retrievalMemory.latest=a[0];break}}if(!e.retrievalMemory.latest){var i='Could not find any valid vocabulary file in the Schema.org versions file (to be declared as "latest".';throw e.onError(i),new Error(i)}}return}var s="Schema.org versions file has an unexpected structure!";throw e.onError(s+" -> "+e.getVersionFileURI()),new Error(s)}})()}checkURL(e){return _asyncToGenerator(function*(){try{return yield axios.head(e),!0}catch(e){return!1}})()}getLatestSDOVersion(){var e=this;return _asyncToGenerator(function*(){return e.retrievalMemory.latest||(yield e.getSDOVersionFile()),e.retrievalMemory.latest})()}getReleasesURI(){return this.commitBase?"https://raw.githubusercontent.com/schemaorg/schemaorg/"+this.commitBase+"/data/releases/":URI_SEMANTIFY_RELEASES}getVersionFileURI(){return this.commitBase?"https://raw.githubusercontent.com/schemaorg/schemaorg/"+this.commitBase+"/versions.json":URI_SEMANTIFY_VERSIONS}}module.exports=SDOAdapter;

},{"./Graph":68,"./utilities":73,"axios":1}],72:[function(require,module,exports){
"use strict";var util=require("./utilities");class Term{constructor(e,t){this.IRI=e,this.graph=t}getIRI(){return arguments.length>0&&void 0!==arguments[0]&&arguments[0]?this.IRI:util.toAbsoluteIRI(this.IRI,this.graph.context)}getTermType(){throw new Error("must be implemented by subclass!")}getTermObj(){throw new Error("must be implemented by subclass!")}getVocabURLs(){var e=this.getTermObj();return util.isNil(e.vocabURLs)?null:e.vocabURLs}getVocabulary(){var e=this.getTermObj();return util.isNil(e["schema:isPartOf"])?null:e["schema:isPartOf"]}getSource(){var e=this.getTermObj();return util.isNil(e["dc:source"])?util.isNil(e["schema:source"])?null:e["schema:source"]:e["dc:source"]}isSupersededBy(){var e=this.getTermObj();return util.isString(e["schema:supersededBy"])?e["schema:supersededBy"]:null}getName(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"en",t=this.getTermObj()["rdfs:label"];return util.isNil(t)||util.isNil(t[e])?null:t[e]}getDescription(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"en",t=this.getTermObj()["rdfs:comment"];return util.isNil(t)||util.isNil(t[e])?null:t[e]}toString(){return JSON.stringify(this.toJSON(!1,null),null,2)}toJSON(){var e={};return e.id=this.getIRI(!0),e.IRI=this.getIRI(),e.type=this.getTermType(),e.vocabURLs=this.getVocabURLs(),e.vocabulary=this.getVocabulary(),e.source=this.getSource(),e.supersededBy=this.isSupersededBy(),e.name=this.getName(),e.description=this.getDescription(),e}}module.exports=Term;

},{"./utilities":73}],73:[function(require,module,exports){
"use strict";function asyncGeneratorStep(e,r,s,t,a,o,c){try{var i=e[o](c),n=i.value}catch(e){return void s(e)}i.done?r(n):Promise.resolve(n).then(t,a)}function _asyncToGenerator(e){return function(){var r=this,s=arguments;return new Promise(function(t,a){var o=e.apply(r,s);function c(e){asyncGeneratorStep(o,t,a,c,i,"next",e)}function i(e){asyncGeneratorStep(o,t,a,c,i,"throw",e)}c(void 0)})}}var jsonld=require("jsonld");function applyFilter(e,r,s){if(!Array.isArray(e)||0===e.length||null===r||0===Object.keys(r).length)return e;var t=[],a=s.context;if(isString(r.fromVocabulary)){for(var o of Object.keys(a))if(a[o]===r.fromVocabulary){r.fromVocabulary=o;break}}else if(isArray(r.fromVocabulary))for(var c=0;c<r.fromVocabulary.length;c++)for(var i=0;i<Object.keys(a).length;i++)if(a[Object.keys(a)[i]]===r.fromVocabulary[c]){r.fromVocabulary[c]=Object.keys(a)[i];break}for(var n=0;n<e.length;n++){var f=s.getTerm(e[n]);if(void 0!==r.isSuperseded){if(!1===r.isSuperseded&&null!=f.isSupersededBy())continue;if(!0===r.isSuperseded&&null==f.isSupersededBy())continue}if(r.fromVocabulary){var l=!1;if(isString(r.fromVocabulary))r.fromVocabulary&&f.getIRI(!0).startsWith(r.fromVocabulary)&&(l=!0);else if(isArray(r.fromVocabulary))for(var u=0;u<r.fromVocabulary.length;u++)f.getIRI(!0).startsWith(r.fromVocabulary[u])&&(l=!0);if(!l)continue}if(r.termType){var d=!1,m=[];isString(r.termType)?m.push(r.termType):isArray(r.termType)&&(m=r.termType);for(var h=0;h<m.length;h++){var p=void 0;switch(m[h]){case"Class":p="rdfs:Class";break;case"Property":p="rdf:Property";break;case"Enumeration":p="schema:Enumeration";break;case"EnumerationMember":p="soa:EnumerationMember";break;case"DataType":p="schema:DataType";break;default:throw new Error("Invalid filter.termType "+m[h])}if(p===f.getTermType()){d=!0;break}}if(!d)continue}t.push(e[n])}return t}function copByVal(e){if(void 0!==e)return JSON.parse(JSON.stringify(e))}function isObject(e){return!Array.isArray(e)&&(!isNil(e)&&"object"==typeof e)}function isNil(e){return null==e}function isString(e){return!isNil(e)&&("string"==typeof e||e instanceof String)}function isArray(e){return Array.isArray(e)}function uniquifyArray(e){var r={},s=[];for(var t of e)r[t]||(r[t]=1,s.push(t));return s}function generateContext(e,r){var s=Object.keys(e),t=Object.keys(r),a=copByVal(e);for(var o of t)if(isString(r[o])){var c=!1;for(var i of s)if(isString(a[i])&&a[i]===r[o]){c=!0;break}if(c)continue;if(a[o]){if(a[o]!==r[o])for(var n=!1,f=1;!1===n;){var l=o+f++;a[l]||(n=!0,a[l]=r[o])}}else a[o]=r[o]}var u={};Object.keys(a).sort().forEach(function(e){u[e]=a[e]}),a=u;var d=Object.keys(a),m={};for(var h of d)isString(a[h])&&(m[h]=a[h]);for(var p of d)isObject(a[p])&&(m[p]=a[p]);return m}function preProcessVocab(e,r){return _preProcessVocab.apply(this,arguments)}function _preProcessVocab(){return(_preProcessVocab=_asyncToGenerator(function*(e,r){var s=!1;do{var t=[];s=!1;for(var a=0;a<e["@graph"].length;a++)void 0!==e["@graph"][a]["@graph"]?(t.push(...copByVal(e["@graph"][a]["@graph"])),s=!0):t.push(copByVal(e["@graph"][a]));e["@graph"]=copByVal(t)}while(!0===s);var o=yield jsonld.compact(e,r);return void 0===o["@graph"]?(delete o["@context"],{"@context":r,"@graph":[o]}):o})).apply(this,arguments)}function curateVocabNode(e,r){if(void 0!==e["rdfs:comment"]){if(isString(e["rdfs:comment"]))e["rdfs:comment"]={en:e["rdfs:comment"]};else if(isObject(e["rdfs:comment"])){var s={};s[e["rdfs:comment"]["@language"]]=e["rdfs:comment"]["@value"],e["rdfs:comment"]=copByVal(s)}else if(isArray(e["rdfs:comment"])){for(var t={},a=0;a<e["rdfs:comment"].length;a++)isObject(e["rdfs:comment"][a])&&(t[e["rdfs:comment"][a]["@language"]]=e["rdfs:comment"][a]["@value"]);e["rdfs:comment"]=copByVal(t)}}else e["rdfs:comment"]={};if(void 0!==e["rdfs:label"]){if(isString(e["rdfs:label"]))e["rdfs:label"]={en:e["rdfs:label"]};else if(isObject(e["rdfs:label"])){var o={};o[e["rdfs:label"]["@language"]]=e["rdfs:label"]["@value"],e["rdfs:label"]=copByVal(o)}else if(isArray(e["rdfs:label"])){for(var c={},i=0;i<e["rdfs:label"].length;i++)isObject(e["rdfs:label"][i])&&(c[e["rdfs:label"][i]["@language"]]=e["rdfs:label"][i]["@value"]);e["rdfs:label"]=copByVal(c)}}else e["rdfs:label"]={};if(isString(e["rdfs:subClassOf"])?e["rdfs:subClassOf"]=[e["rdfs:subClassOf"]]:void 0===e["rdfs:subClassOf"]&&"rdfs:Class"===e["@type"]&&(e["rdfs:subClassOf"]=[]),isString(e["rdfs:subPropertyOf"])?e["rdfs:subPropertyOf"]=[e["rdfs:subPropertyOf"]]:void 0===e["rdfs:subPropertyOf"]&&"rdf:Property"===e["@type"]&&(e["rdfs:subPropertyOf"]=[]),isString(e["schema:domainIncludes"])?e["schema:domainIncludes"]=[e["schema:domainIncludes"]]:void 0===e["schema:domainIncludes"]&&"rdf:Property"===e["@type"]&&(e["schema:domainIncludes"]=[]),isString(e["schema:rangeIncludes"])?e["schema:rangeIncludes"]=[e["schema:rangeIncludes"]]:void 0===e["schema:rangeIncludes"]&&"rdf:Property"===e["@type"]&&(e["schema:rangeIncludes"]=[]),void 0===e["schema:inverseOf"]&&"rdf:Property"===e["@type"]&&(e["schema:inverseOf"]=null),!isString(e["schema:isPartOf"])){for(var n,f=Object.keys(r),l=0;l<f.length;l++)if(e["@id"].substring(0,e["@id"].indexOf(":"))===f[l]){n=r[f[l]];break}if(void 0!==n){var u;do{u=!1,(n.endsWith("/")||n.endsWith("#"))&&(n=n.substring(0,n.length-1),u=!0)}while(!0===u);e["schema:isPartOf"]=n}}return e}function toCompactIRI(e,r){var s=arguments.length>2&&void 0!==arguments[2]&&arguments[2];for(var t of Object.keys(r)){var a=r[t];if(isString(a)&&e.startsWith(a))return t+":"+e.substring(a.length);if(s&&isString(a)){var o=switchIRIProtocol(a);if(e.startsWith(o))return t+":"+e.substring(o.length)}}return null}function toAbsoluteIRI(e,r){for(var s=Object.keys(r),t=0;t<s.length;t++){var a=r[s[t]];if(e.substring(0,e.indexOf(":"))===s[t])return a.concat(e.substring(e.indexOf(":")+1))}return null}function sortReleaseEntriesByDate(e){return Object.entries(e).sort((e,r)=>new Date(r[1])-new Date(e[1]))}function getFileNameForSchemaOrgVersion(e){var r=!(arguments.length>1&&void 0!==arguments[1])||arguments[1];switch(e){case"2.0":case"2.1":case"2.2":case"3.0":throw new Error("There is no jsonld file for that schema.org version.");case"3.1":case"3.2":case"3.3":case"3.4":case"3.5":case"3.6":case"3.7":case"3.8":case"3.9":case"4.0":case"5.0":case"6.0":case"7.0":case"7.01":case"7.02":case"7.03":case"7.04":case"8.0":return"all-layers.jsonld";case"9.0":default:return r?"schemaorg-all-https.jsonld":"schemaorg-all-http.jsonld"}}function discoverUsedSchemaOrgProtocol(e){var r="https://schema.org/",s="http://schema.org/";if(e["@context"])for(var t of Object.values(e["@context"]))if(isObject(t)&&t["@vocab"]){if(t["@vocab"]===r)return"https";if(t["@vocab"]===s)return"http"}else if(isString(t)){if(t===r)return"https";if(t===s)return"http"}var a=JSON.stringify(e),o=a.split(r).length-1,c=a.split(s).length-1;return o>c?"https":c>o?"http":r}function discoverEquateNamespaces(e,r){var s=new Set,t=[];return Object.values(e).forEach(function(e){isString(e)&&t.push(switchIRIProtocol(e))}),r["@context"]&&Object.values(r["@context"]).forEach(function(e){isString(e)&&t.includes(e)&&s.add(e)}),Array.isArray(r["@graph"])&&r["@graph"].forEach(function(e){checkIfNamespaceFromListIsUsed(e["@id"],t,s),checkIfNamespaceFromListIsUsed(e["@type"],t,s),checkIfNamespaceFromListIsUsed(e["rdfs:subClassOf"],t,s),checkIfNamespaceFromListIsUsed(e["http://www.w3.org/2000/01/rdf-schema#subClassOf"],t,s),checkIfNamespaceFromListIsUsed(e["schema:domainIncludes"],t,s),checkIfNamespaceFromListIsUsed(e["http://schema.org/domainIncludes"],t,s),checkIfNamespaceFromListIsUsed(e["https://schema.org/domainIncludes"],t,s),checkIfNamespaceFromListIsUsed(e["schema:rangeIncludes"],t,s),checkIfNamespaceFromListIsUsed(e["http://schema.org/rangeIncludes"],t,s),checkIfNamespaceFromListIsUsed(e["https://schema.org/rangeIncludes"],t,s),checkIfNamespaceFromListIsUsed(e["rdfs:subPropertyOf"],t,s),checkIfNamespaceFromListIsUsed(e["http://www.w3.org/2000/01/rdf-schema#subPropertyOf"],t,s),checkIfNamespaceFromListIsUsed(e["schema:inverseOf"],t,s),checkIfNamespaceFromListIsUsed(e["http://schema.org/inverseOf"],t,s),checkIfNamespaceFromListIsUsed(e["https://schema.org/inverseOf"],t,s)}),Array.from(s)}function checkIfNamespaceFromListIsUsed(e,r,s){var t;if(Array.isArray(e))e.forEach(function(e){checkIfNamespaceFromListIsUsed(e,r,s)});else if(isObject(e)&&isString(e["@id"])?t=e["@id"]:isString(e)&&(t=e),isString(t)&&t.startsWith("http")){var a=r.find(e=>t.startsWith(e));a&&!s.has(a)&&s.add(a)}}function switchIRIProtocol(e){return e.startsWith("https://")?"http"+e.substring(5):e.startsWith("http://")?"https"+e.substring(4):e}module.exports={applyFilter:applyFilter,copByVal:copByVal,isArray:isArray,isString:isString,isObject:isObject,isNil:isNil,uniquifyArray:uniquifyArray,preProcessVocab:preProcessVocab,generateContext:generateContext,curateVocabNode:curateVocabNode,toCompactIRI:toCompactIRI,toAbsoluteIRI:toAbsoluteIRI,sortReleaseEntriesByDate:sortReleaseEntriesByDate,getFileNameForSchemaOrgVersion:getFileNameForSchemaOrgVersion,discoverUsedSchemaOrgProtocol:discoverUsedSchemaOrgProtocol,discoverEquateNamespaces:discoverEquateNamespaces,switchIRIProtocol:switchIRIProtocol};
...
"use strict";class ClassRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.util.getTypeStructure(this.browser.term),t=this.util.createHtmlHeader(e,"rdfs:subClassOf")+this.createHtmlProperties();this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("rdfs:Class",t)}createHtmlProperties(){var e='<table class="definition-table table">'+this.createHtmlPropertiesHeader();return[this.browser.term,...this.browser.term.getSuperClasses().map(e=>this.browser.sdoAdapter.getClass(e))].forEach(t=>{var r=t.getProperties(!1);0!==r.length&&(e+="<tbody>"+this.createHtmlPropertyHeader(t),r.forEach(t=>{e+=this.util.createPropertyTableRow(t)}),e+="</tbody>")}),e+="</table><br>"+this.createHtmlSpecificTypes()}createHtmlPropertiesHeader(){return"<thead><tr>\n            <th>Property</th>\n            <th>Expected Type</th>\n            <th>Description</th>\n            </tr></thead>"}createHtmlPropertyHeader(e){var t=this.util.createLink(e.getIRI(!0));return'<tbody><tr class="supertype">\n            <th class="supertype-name" colspan="3">\n            Properties from '.concat(t,"\n            </th></tr></tbody>")}createHtmlSpecificTypes(){var e=this.browser.term.getSubClasses(!1);if(0===e.length)return"";var t=e.map(e=>"<li>"+this.util.createLink(e)+"</li>");return'<b><a id="subtypes" title="Link: #subtypes" href="#subtypes" class="clickableAnchor">\n            More specific Types</a></b>\n            <ul>'.concat(t,"</ul><br>")}}module.exports=ClassRenderer;

},{}],79:[function(require,module,exports){
"use strict";class DataTypeRenderer{constructor(t){this.browser=t,this.util=this.browser.util}render(){var t=this.util.createHtmlFullLink("schema:DataType",null,"rdfs:subClassOf")+" > ",e=this.util.getTypeStructure(this.browser.term,"getSuperDataTypes"),r=this.util.createHtmlHeader(e,"",t)+this.util.createHtmlRangesOf();this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("rdfs:Class",r)}}module.exports=DataTypeRenderer;

},{}],80:[function(require,module,exports){
"use strict";class EnumerationMemberRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.browser.term.getDomainEnumerations().flatMap(e=>this.util.getTypeStructure(this.browser.sdoAdapter.getClass(e))),t=" :: "+this.util.createLink(this.browser.term.getIRI(!0)),r=this.util.createHtmlHeader(e,"@type","",t)+this.createHtmlDomains();this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("rdfs:Class",r)}createHtmlDomains(){var e=this.browser.term.getDomainEnumerations();return"A member value for enumeration"+(e.length>1?"s":"")+": "+e.map(e=>this.util.createLink(e)).join(", ")+"<br>"}}module.exports=EnumerationMemberRenderer;

},{}],81:[function(require,module,exports){
"use strict";class EnumerationRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.util.getTypeStructure(this.browser.term),t=this.util.createHtmlHeader(e,"rdfs:subClassOf")+this.createHtmlEnumerationMembers()+this.util.createHtmlRangesOf(!0);this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("rdfs:Class",t)}createHtmlEnumerationMembers(){var e=this.browser.term.getEnumerationMembers();if(0===e.length)return"";var t=e.map(e=>"<li>"+this.util.createLink(e)+"</li>").join("");return"An Enumeration with enumeration members:<br><ul>".concat(t,"</ul><br>")}}module.exports=EnumerationRenderer;

},{}],82:[function(require,module,exports){
"use strict";class ListRenderer{constructor(t){this.browser=t,this.util=this.browser.util}render(){var t=this.createHtmlHeader()+this.createHtmlVocabsTable();this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("schema:DataSet",t)}createHtmlHeader(){var t=this.browser.list["schema:name"],e=this.util.createHtmlExternalLinkLegend(),a=this.browser.list["schema:description"]||"";return"<h1>".concat(t,"</h1>\n            ").concat(e,"\n            ").concat(a)}createHtmlVocabsTable(){return this.util.createHtmlDefinitionTable(["Name","IRI","Author","Description"],this.createHtmlVocabsTbody(),{class:"supertype"})}createHtmlVocabsTbody(){return this.browser.list["schema:hasPart"].map(t=>this.util.createHtmlTableRow("http://vocab.sti2.at/ds/Vocabulary",t["@id"],"schema:name",this.util.createInternalLink({vocId:t["@id"].split("/").pop()},t["schema:name"]||"No Name"),this.createHtmlVocabsSideCols(t))).join("")}createHtmlVocabsSideCols(t){var e=this.util.createExternalLink(t["@id"]),a=t["schema:author"]&&t["schema:author"]["schema:name"]||"",r=t["schema:description"]||"";return'<td property="@id">'.concat(e,'</td>\n            <td property="schema:author">').concat(a,'</td>\n            <td property="schema:description">').concat(r,"</td>")}}module.exports=ListRenderer;

},{}],83:[function(require,module,exports){
"use strict";class PropertyRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.createHtmlStartBreadcrumbs(),t=this.util.getTypeStructure(this.browser.term,"getSuperProperties"),r=this.util.createHtmlHeader(t,"rdfs:subPropertyOf",e)+this.createHtmlRanges()+this.createHtmlDomainIncludes()+this.createHtmlSuperProperties()+this.createHtmlSubProperties();this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("rdf:Property",r)}createHtmlStartBreadcrumbs(){return this.util.createLink("schema:Thing")+" > "+this.util.createLink("schema:Property",{title:"Defined in section: meta.schema.org"})+" > "}createHtmlRanges(){var e=this.browser.term.getRanges(!1).map(e=>{var t={title:"The '"+this.browser.term.getIRI(!0)+"' property has values that include instances of the '"+e+"' type."};return this.util.createHtmlCodeWithLink(e,null,t,"rangeIncludes")}).join("<br>");return this.util.createHtmlDefinitionTable("Values expected to be one of these types","<td>"+e+"</td>")}createHtmlDomainIncludes(){var e=this.browser.term.getDomains(!1).map(e=>{var t={title:"The '"+this.browser.term.getIRI(!0)+"' property is used on the '"+e+"' type"};return this.util.createHtmlCodeWithLink(e,null,t,"domainIncludes")}).join("<br>");return this.util.createHtmlDefinitionTable("Used on these types","<td>"+e+"</td>")}createHtmlSuperProperties(){var e=this.browser.term.getSuperProperties(!1);return this.createHtmlRelatedProperties(e,"Super-properties")}createHtmlRelatedProperties(e,t){if(0===e.length)return"";var r=e.map(e=>{var t={title:e+": ''"+this.util.repairLinksInHTMLCode(this.browser.sdoAdapter.getProperty(e).getDescription()||"")+"''"};return this.util.createHtmlCodeWithLink(e,null,t)}).join("<br>");return this.util.createHtmlDefinitionTable(t,"<td>"+r+"</td>")}createHtmlSubProperties(){var e=this.browser.term.getSubProperties(!1);return this.createHtmlRelatedProperties(e,"Sub-properties")}}module.exports=PropertyRenderer;

},{}],84:[function(require,module,exports){
"use strict";var _schemaOrgAdapter=_interopRequireDefault(require("schema-org-adapter")),_Util=_interopRequireDefault(require("./Util")),_ListRenderer=_interopRequireDefault(require("./ListRenderer")),_VocabRenderer=_interopRequireDefault(require("./VocabRenderer")),_ClassRenderer=_interopRequireDefault(require("./ClassRenderer")),_PropertyRenderer=_interopRequireDefault(require("./PropertyRenderer")),_EnumerationRenderer=_interopRequireDefault(require("./EnumerationRenderer")),_EnumerationMemberRenderer=_interopRequireDefault(require("./EnumerationMemberRenderer")),_DataTypeRenderer=_interopRequireDefault(require("./DataTypeRenderer"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function asyncGeneratorStep(e,t,r,n,i,o,a){try{var s=e[o](a),l=s.value}catch(e){return void r(e)}s.done?t(l):Promise.resolve(l).then(n,i)}function _asyncToGenerator(e){return function(){var t=this,r=arguments;return new Promise(function(n,i){var o=e.apply(t,r);function a(e){asyncGeneratorStep(o,n,i,a,s,"next",e)}function s(e){asyncGeneratorStep(o,n,i,a,s,"throw",e)}a(void 0)})}}class SDOVocabBrowser{constructor(e){var t=this;this.vocabCache={},this.util=new _Util.default(this),this.listRenderer=new _ListRenderer.default(this),this.vocabRenderer=new _VocabRenderer.default(this),this.classRenderer=new _ClassRenderer.default(this),this.propertyRenderer=new _PropertyRenderer.default(this),this.enumerationRenderer=new _EnumerationRenderer.default(this),this.enumerationMemberRenderer=new _EnumerationMemberRenderer.default(this),this.dataTypeRenderer=new _DataTypeRenderer.default(this),this.targetElement=e.targetElement,this.locationControl=!1!==e.locationControl,this.selfFileHost=!0===e.selfFileHost,this.locationControl?this.readStateFromUrl():(this.listId=e.listId||null,this.vocId=e.vocId||null,this.termURI=e.termURI||null,this.format=e.format||null),this.locationControl&&window.addEventListener("popstate",_asyncToGenerator(function*(){t.readStateFromUrl(),yield t.render()}))}render(){var e=this;return _asyncToGenerator(function*(){e.targetElement.innerHTML='<img src="https://raw.githubusercontent.com/semantifyit/schema-org-vocab-browser/main/images/loading.gif"\n            alt="Loading Animation" style="margin-top: 6px">',yield e.renderInit(),e.listId&&!e.vocId?e.listRenderer.render():e.vocId&&!e.termURI?"jsonld"===e.format?e.vocabRenderer.renderJsonld():e.vocabRenderer.render():e.termURI&&e.renderTerm(),e.addJSLinkEventListener(),e.addSectionLinkEventListener(),document.body.scrollTop=document.documentElement.scrollTop=0})()}renderInit(){var e=this;return _asyncToGenerator(function*(){!e.listId||e.list&&e.list["@id"].endsWith(e.listId)||(e.list=yield e.util.parseToObject(e.util.getFileHost()+"/list/"+e.listId+"?representation=lean")),!e.vocId||e.vocab&&e.vocab["@id"].endsWith(e.vocId)||(yield e.initVocab())})()}initVocab(){var e=this;return _asyncToGenerator(function*(){if(!e.vocabCache[e.vocId]){var t=yield e.util.parseToObject(e.util.getFileHost()+"/voc/"+e.vocId),r=new _schemaOrgAdapter.default({schemaHttps:!0,equateVocabularyProtocols:!0}),n=yield r.constructSDOVocabularyURL("latest");yield r.addVocabularies([n,t]),e.vocabCache[e.vocId]={vocabFile:t,sdoAdapter:r}}e.vocab=e.vocabCache[e.vocId].vocabFile,e.sdoAdapter=e.vocabCache[e.vocId].sdoAdapter,e.namespaces=e.sdoAdapter.getVocabularies(),delete e.namespaces.schema;var i=Object.keys(e.namespaces);e.classes=e.sdoAdapter.getListOfClasses({fromVocabulary:i}),e.properties=e.sdoAdapter.getListOfProperties({fromVocabulary:i}),e.enumerations=e.sdoAdapter.getListOfEnumerations({fromVocabulary:i}),e.enumerationMembers=e.sdoAdapter.getListOfEnumerationMembers({fromVocabulary:i}),e.dataTypes=e.sdoAdapter.getListOfDataTypes({fromVocabulary:i})})()}getVocabName(){if(this.vocab&&this.list){var e=this.list["schema:hasPart"].find(e=>e["@id"].split("/").pop()===this.vocId);if(e)return e["schema:name"]}return""}renderTerm(){switch(this.term=this.sdoAdapter.getTerm(this.termURI),this.term.getTermType()){case"rdfs:Class":this.classRenderer.render();break;case"rdf:Property":this.propertyRenderer.render();break;case"schema:Enumeration":this.enumerationRenderer.render();break;case"soa:EnumerationMember":this.enumerationMemberRenderer.render();break;case"schema:DataType":this.dataTypeRenderer.render()}}addJSLinkEventListener(){var e=this,t=this.targetElement.getElementsByClassName("a-js-link"),r=function(t){t.addEventListener("click",function(){var r=_asyncToGenerator(function*(r){e.locationControl?r.ctrlKey?window.open(t.href):(history.pushState(null,null,t.href),e.navigate(JSON.parse(decodeURIComponent(t.getAttribute("data-state-changes"))))):e.navigate(JSON.parse(decodeURIComponent(t.getAttribute("data-state-changes"))))});return function(e){return r.apply(this,arguments)}}())};for(var n of t)r(n)}addSectionLinkEventListener(){var e=this,t=this.targetElement.getElementsByClassName("a-section-link"),r=function(t){t.addEventListener("click",function(){var r=_asyncToGenerator(function*(r){e.locationControl?r.ctrlKey?window.open(t.href):(history.pushState(null,null,t.href),e.scrollToSection(decodeURIComponent(t.getAttribute("data-section-link")))):e.scrollToSection(decodeURIComponent(t.getAttribute("data-section-link")))});return function(e){return r.apply(this,arguments)}}())};for(var n of t)r(n)}navigate(e){void 0!==e.listId&&(this.listId=e.listId),void 0!==e.vocId&&(this.vocId=e.vocId),void 0!==e.termURI&&(this.termURI=e.termURI),void 0!==e.format&&(this.format=e.format),null===this.listId&&(this.list=void 0),null===this.vocId&&(this.vocab=void 0),this.vocab||(this.termURI=null),this.locationControl&&history.replaceState(null,null," "),this.render()}scrollToSection(e){e=this.util.underscore(e);["Classes","Properties","Enumerations","Enumeration_Members","Data_Types"].includes(e)&&window.scrollTo({top:window.pageYOffset+document.getElementById(e).getBoundingClientRect().top,left:0,behavior:"smooth"})}readStateFromUrl(){var e=new URLSearchParams(window.location.search);if(this.format=e.get("format")||null,this.termURI=e.get("term")||null,window.location.pathname.includes("/voc/")){this.listId=null;var t=window.location.pathname.substring("/voc/".length);this.vocId!==t&&(this.vocId=t,this.vocab=null)}else if(window.location.pathname.includes("/list/")){var r=window.location.pathname.substring("/list/".length);this.listId!==r&&(this.listId=r,this.list=null);var n=e.get("voc")||null;this.vocId!==n&&(this.vocId=n,this.vocab=null)}else this.listId=null,this.list=null,this.vocId=null,this.vocab=null}}module.exports=SDOVocabBrowser;
...
"use strict";function asyncGeneratorStep(t,e,r,a,n,i,o){try{var s=t[i](o),c=s.value}catch(t){return void r(t)}s.done?e(c):Promise.resolve(c).then(a,n)}function _asyncToGenerator(t){return function(){var e=this,r=arguments;return new Promise(function(a,n){var i=t.apply(e,r);function o(t){asyncGeneratorStep(i,a,n,o,s,"next",t)}function s(t){asyncGeneratorStep(i,a,n,o,s,"throw",t)}o(void 0)})}}class Util{constructor(t){this.browser=t}parseToObject(t){var e=this;return _asyncToGenerator(function*(){var r;return e.isString(t)?(r=e.isValidUrl(t)?yield e.getJsonld(t):t,JSON.parse(r)):t})()}isString(t){return"string"==typeof t||t instanceof String}isValidUrl(t){try{new URL(t)}catch(t){return!1}return!0}getJsonld(t){return new Promise(function(e,r){var a=new XMLHttpRequest;a.open("GET",t),a.setRequestHeader("Accept","application/ld+json"),a.onload=function(){this.status>=200&&this.status<300?e(a.response):r({status:this.status,statusText:a.statusText})},a.onerror=function(){r({status:this.status,statusText:a.statusText})},a.send()})}createIriWithQueryParam(t,e){var r=new URLSearchParams(window.location.search);e&&""!==e?r.set(t,e):r.delete(t);var a=r.toString();return window.location.protocol+"//"+(window.location.host?window.location.host:"")+window.location.pathname+(""!==a?"?"+a:"")}createHtmlTableRow(t,e,r,a,n){var i=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null,o=this.createHtmlMainCol(r,a,i);return'<tr typeof="'.concat(t,'" resource="').concat(e,'">\n            ').concat(o," ").concat(n,"</tr>")}createHtmlMainCol(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,a=this.createHtmlCodeWithLink(e,{property:t});return"<th ".concat(r?' class="'+r+'"':"",' scope="row">').concat(a,"</th>")}createHtmlCodeWithLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,n=this.createHtmlAttr(e),i=this.createHtmlFullLink(t,r,a);return"<code ".concat(n,">").concat(i,"</code>")}createHtmlFullLink(t,e,r){var a;try{a=this.browser.sdoAdapter.getTerm(t)}catch(t){a=null}return(r?this.createHtmlSemanticLink(r,t):"")+(a?this.createLink(t,e):t)}createInternalLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;e=this.escHtml(e);var a=this.browser.locationControl?this.createInternalHref(t):"javascript:void(0)",n=this.browser.locationControl?'onclick="return false;"':"",i=this.createHtmlAttr(r),o='data-state-changes="'+encodeURIComponent(JSON.stringify(t))+'"';return'<a class="a-js-link" href="'.concat(a,'" ').concat(i," ").concat(n," ").concat(o,">\n        ").concat(e,"</a>")}createInternalHref(t){var e,r=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],a=this.createNavigationState(t),n=window.location.protocol+"//"+(window.location.host?window.location.host:""),i=[];a.listId?(e=n+"/list/"+a.listId,a.vocId&&i.push(["voc",a.vocId])):e=n+"/voc/"+a.vocId,a.termURI&&i.push(["term",a.termURI]),a.format&&i.push(["format",a.format]);for(var o=0;o<i.length;o++){var s="&";0===o&&(s="?"),e+=s+encodeURIComponent(i[o][0])+"="+encodeURIComponent(i[o][1])}return r?this.escHtml(e):e}createNavigationState(t){var e={};for(var r of["listId","vocId","termURI","format"])void 0!==t[r]?e[r]=t[r]:e[r]=this.browser[r];return e}escHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}createHtmlAttr(t){return t?Object.entries(t).map(t=>" "+this.escHtml(t[0])+'="'+this.escHtml(t[1])+'"').join(""):""}createExternalLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,a=new URL(t);if(window.location.hostname!==a.hostname){var n=" "+this.createExternalLinkStyle(t);r?r.hasOwnProperty("style")?r.style=r.style+n:r.style=n:r={style:n},r.target="_blank"}return'<a href="'+this.escHtml(t)+'"'+this.createHtmlAttr(r)+">"+(e?this.prettyPrintIri(e):this.prettyPrintIri(t))+"</a>"}createExternalLinkStyle(t){var e="background-position: center right; \n            background-repeat: no-repeat; \n            background-size: 10px 10px; \n            padding-right: 13px; ";return-1===t.indexOf("https://schema.org")&&-1===t.indexOf("http://schema.org")?e+="background-image: url(https://raw.githubusercontent.com/semantifyit/schema-org-vocab-browser/main/images/external-link-icon-blue.png);":e+="background-image: url(https://raw.githubusercontent.com/semantifyit/schema-org-vocab-browser/main/images/external-link-icon-red.png);",e}prettyPrintIri(t){return t.replace(/^(schema:|https?:\/\/schema.org\/)(.+)/,"$2")}createHtmlMainContent(t,e){var r=window.location;return'<div id="mainContent" vocab="http://schema.org/" typeof="'.concat(t,'" resource="').concat(r,'">').concat(e,"</div>")}underscore(t){return t.replace(/ /g,"_")}getTypeStructure(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"getSuperClasses",r=t[e](!1);if(0===r.length)return[[t.getIRI(!0)]];var a=[];return r.forEach(r=>{var n=this.browser.sdoAdapter.getTerm(r);this.getTypeStructure(n,e).forEach(e=>{e.push(t.getIRI(!0)),a.push(e)})}),a}createHtmlHeader(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"",a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"",n=this.browser.term,i=n.getIRI(!0),o=this.repairLinksInHTMLCode(n.getDescription())||"",s="(from Vocabulary: "+this.createInternalLink({termURI:null},this.browser.getVocabName()||"Vocabulary")+")",c=this.createHtmlExternalLinkLegend(),l=this.createHtmlTypeStructureBreadcrumbs(t,e,r,a);return'<span style="float: right;">'.concat(s,'</span>\n            <h1 property="rdfs:label" class="page-title">').concat(i,"</h1>\n            ").concat(c," ").concat(l,'\n            <div property="rdfs:comment">').concat(o,"<br><br></div>")}createHtmlExternalLinkLegend(){var t="margin-right: 3px; "+this.createExternalLinkStyle(""),e="margin-right: 3px; "+this.createExternalLinkStyle("https://schema.org")+" margin-left: 6px;";return'<p style="font-size: 12px; margin-top: 0">\n            (<span style="'.concat(t,'"></span>External link\n            <span style="').concat(e,'"></span>External link to schema.org)</p>')}createHtmlTypeStructureBreadcrumbs(t,e,r,a){return"<h4>"+t.map(t=>'<span class="breadcrumbs">'+r+t.map((r,n)=>{var i="";return(""===a&&n+2===t.length||""!==a&&n+1===t.length)&&(i+=this.createHtmlSemanticLink(e,r)),i+=this.createLink(r)}).join(" > ")+a+"</span>").join("<br>")+"</h4>"}createHtmlSemanticLink(t,e){var r=this.escHtml(t),a=this.escHtml(this.createHref(e));return'<link property="'.concat(r,'" href="').concat(a,'">')}createHref(t){return this.isTermOfVocab(t)?this.createIriWithQueryParam("term",t):this.browser.sdoAdapter.getTerm(t).getIRI()}isTermOfVocab(t){return this.browser.vocab&&(this.browser.classes.includes(t)||this.browser.properties.includes(t)||this.browser.enumerations.includes(t)||this.browser.enumerationMembers.includes(t)||this.browser.dataTypes.includes(t))}createLink(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.isTermOfVocab(t)?this.createInternalLink({termURI:t},t,e):this.createExternalLink(this.createHref(t),t,e)}createPropertyTableRow(t){var e=arguments.length>1&&void 0!==arguments[1]&&arguments[1];return this.createHtmlTableRow("rdf:Property",this.createHref(t),"rdfs:label",this.createLink(t),this.createHtmlPropertySideCols(t,e),"prop-name")}createHtmlPropertySideCols(t,e){var r=this.browser.sdoAdapter.getProperty(t),a=this.createHtmlPropertyRange(r,e),n=this.repairLinksInHTMLCode(r.getDescription())||"";return'<td class="prop-etc">'.concat(a,'</td>\n            <td class="prop-desc" property="rdfs:comment">').concat(n,"</td>")}createHtmlPropertyRange(t,e){var r="";return e||(r=t.getRanges(!1).map(t=>this.createHtmlSemanticLink("rangeIncludes",t)+this.createLink(t)).join("&nbsp; or <br>")),r+t.getDomains(!1).map(t=>this.createHtmlSemanticLink("domainIncludes",t)+(e?this.createLink(t):"")).join(e?"&nbsp; or <br>":"")}createHtmlDefinitionTable(t,e){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;Array.isArray(t)||(t=[t]),Array.isArray(e)||(e=[e]);var a=t.map(t=>"<th>"+t+"</th>").join(""),n=e[0].startsWith("<tr")?e.join(""):e.map(t=>"<tr>"+t+"</tr>").join(""),i=this.createHtmlAttr(r);return'<table class="definition-table table">\n            <thead><tr>'.concat(a,"</tr></thead>\n            <tbody ").concat(i,">").concat(n,"</tbody></table>")}createHtmlRangesOf(){var t=arguments.length>0&&void 0!==arguments[0]&&arguments[0],e=this.browser.term.isRangeOf(!1);if(0===e.length)return"";var r=e.map(t=>this.createPropertyTableRow(t,!0)),a=this.createLink(this.browser.term.getIRI(!0)),n=t?"and its enumeration members or subtypes ":"",i=this.createHtmlDefinitionTable(["Property","On Types","Description"],r);return'<div id="incoming">Instances of '.concat(a," ").concat(n,"may appear as a value for the following properties\n            </div><br>").concat(i)}getFileHost(){return this.browser.selfFileHost?window.location.origin:"https://semantify.it"}repairLinksInHTMLCode(t){var e=t;return e=(e=(e=(e=(e=(e=e.replace(/<a(.*?)href="(.*?)"/g,(t,e,r)=>{return r.startsWith("/")&&(r="http://schema.org"+r),"<a"+e+'href="'+r+'" style="'+this.createExternalLinkStyle(r)+'" target="_blank"'})).replace(/\[\[(.*?)]]/g,(t,e)=>{var r="http://schema.org/"+e;return'<a href="'+r+'" style="'+this.createExternalLinkStyle(r)+'" target="_blank">'+e+"</a>"})).replace(/\[(.*?)]\((.*?)\)/g,(t,e,r)=>{return r.startsWith("/")?r="http://schema.org"+r:r.startsWith("http")||(r="http://schema.org/"+r),'<a href="'+r+'" style="'+this.createExternalLinkStyle(r)+'" target="_blank">'+e+"</a>"})).replace(/\\n/g,t=>"</br>")).replace(/__(.*?)__/g,(t,e)=>"<b>"+e+"</b>")).replace(/```(.*?)```/g,(t,e)=>"<code>"+e+"</code>")}}module.exports=Util;

},{}],86:[function(require,module,exports){
"use strict";var TYPES_PLURAL={Class:"Classes",Property:"Properties",Enumeration:"Enumerations","Enumeration Member":"Enumeration Members","Data Type":"Data Types"};class VocabRenderer{constructor(e){this.browser=e,this.util=this.browser.util}renderJsonld(){var e=JSON.stringify(this.browser.vocab,null,2);this.browser.targetElement.innerHTML='<pre style="'.concat("font-size: medium; \n            background: none; \n            text-align: left; \n            width: auto; \n            padding: 0; \n            overflow: visible; \n            color: rgb(0, 0, 0); \n            line-height: normal; ä\n            display: block; \n            font-family: monospace; \n            margin: 1em 0; \n            word-wrap: break-word; \n            white-space: pre-wrap;",'">').concat(e,"</pre>")}render(){var e=this.createHeading()+this.createNamespaces()+this.createContentSection()+this.createSection(this.browser.classes,"Class")+this.createSection(this.browser.properties,"Property")+this.createSection(this.browser.enumerations,"Enumeration")+this.createSection(this.browser.enumerationMembers,"Enumeration Member")+this.createSection(this.browser.dataTypes,"Data Type");this.browser.targetElement.innerHTML=this.util.createHtmlMainContent("schema:DataSet",e),""!==window.location.hash&&this.browser.scrollToSection(window.location.hash.substring(1))}createHeading(){var e;e=this.browser.locationControl?this.util.createInternalLink({format:"jsonld"},"JSON-LD serialization"):'<a href="https://semantify.it/voc/'.concat(this.browser.vocId,'?format=jsonld" target="_blank">JSON-LD serialization</a>');var t=this.browser.list?" | from List: "+this.util.createInternalLink({vocId:null},this.browser.list["schema:name"]):"",r=this.browser.getVocabName()||"Vocabulary",n=this.util.createHtmlExternalLinkLegend();return'<span style="float: right;">('.concat(e," ").concat(t,")</span>\n                <h1>").concat(r,"</h1>").concat(n)}createNamespaces(){return'<h2 style="margin: revert;">Namespaces</h2><ul>'+Object.entries(this.browser.namespaces).map(e=>"<li>"+e[0]+": "+this.util.createExternalLink(e[1])+"</li>").join("")+"</ul>"}createContentSection(){return'<h2 style="margin: revert;">Content</h2><ul>'+this.createContentListElement(this.browser.classes,"Class")+this.createContentListElement(this.browser.properties,"Property")+this.createContentListElement(this.browser.enumerations,"Enumeration")+this.createContentListElement(this.browser.enumerationMembers,"Enumeration Member")+this.createContentListElement(this.browser.dataTypes,"Data Type")+"</ul>"}createContentListElement(e,t){if(0===e.length)return"";var r=TYPES_PLURAL[t],n=this.browser.locationControl?"#"+this.util.underscore(r):"javascript:void(0)",i=this.browser.locationControl?'onclick="return false;"':"",a=e.length+" "+(1===e.length?t:r);return'<li><a class="a-section-link" href="'.concat(n,'" data-section-link="').concat(r,'" ').concat(i,">").concat(a,"</a></li>")}createSection(e,t){if(0!==e.length){var r,n=TYPES_PLURAL[t];return r="Enumeration Member"===t?[t,"of Enumeration","Description"]:[t,"Description"],'<h2 id="'+this.util.underscore(n)+'">'+n+"</h2>"+this.util.createHtmlDefinitionTable(r,this.createSectionTbody(e,t),{class:"supertype"})}return""}createSectionTbody(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return e.map(e=>{var r=this.browser.sdoAdapter.getTerm(e),n="";if("Enumeration Member"===t){var i="";try{var a=this.browser.sdoAdapter.getEnumerationMember(e).getDomainEnumerations(!1);for(var s of a)i+=this.util.createInternalLink({termURI:s},s)+"</br>"}catch(e){}n+="<td>".concat(i,"</td>")}return n+='<td property="rdfs:comment">'+this.util.repairLinksInHTMLCode(r.getDescription()||"")+"</td>",this.util.createHtmlTableRow(r.getTermType(),this.util.createIriWithQueryParam("term",e),"@id",this.util.createInternalLink({termURI:e},e),n)}).join("")}}module.exports=VocabRenderer;
