...
"use strict";function asyncGeneratorStep(e,r,t,n,a,i,s){try{var o=e[i](s),c=o.value}catch(e){return void t(e)}o.done?r(c):Promise.resolve(c).then(n,a)}function _asyncToGenerator(e){return function(){var r=this,t=arguments;return new Promise(function(n,a){var i=e.apply(r,t);function s(e){asyncGeneratorStep(i,n,a,s,o,"next",e)}function o(e){asyncGeneratorStep(i,n,a,s,o,"throw",e)}s(void 0)})}}class Util{constructor(e){this.browser=e}addTermEventListener(){var e=this,r=document.getElementsByClassName("a-term-name"),t=function(r){r.addEventListener("click",_asyncToGenerator(function*(){history.pushState(null,null,e.createIRIwithQueryParam("term",r.innerText)),yield e.browser.render()}))};for(var n of r)t(n)}createIRIwithQueryParam(e,r){var t=new URLSearchParams(window.location.search);return t.set(e,r),window.location.origin+window.location.pathname+"?"+t.toString()}createTableRow(e,r,t,n,a){var i=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null;return'<tr typeof="'+e+'" resource="'+r+'">'+this.createMainColEntry(t,n,i)+a+"</tr>"}createMainColEntry(e,r){var t=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return"<th"+(t?' class="'+t+'"':"")+' scope="row">'+this.createCodeLink(r,{property:e})+"</th>"}createCodeLink(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;return"<code"+this.createHTMLAttr(r)+">"+this.createFullLink(e,t,n)+"</code>"}createFullLink(e,r,t){var n=null;try{n=this.browser.sdoAdapter.getTerm(e)}catch(e){}return""+(t?this.createSemanticLink(t,e):"")+(n?this.createLink(e,r):e)}createJSLink(e,r,t){var n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null;return"<a "+this.createAttrForJSLink(e,r,t,a)+">"+(n?this.escHTML(n):this.escHTML(t))+"</a>"}createAttrForJSLink(e,r,t){var n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,a=this.createIRIwithQueryParam(r,t);return'class="'+this.escHTML(e)+'" href="'+this.escHTML(a)+'" onclick="return false;"'+this.createHTMLAttr(n)}escHTML(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}createHTMLAttr(e){return e?Object.entries(e).map(e=>" "+this.escHTML(e[0])+'="'+this.escHTML(e[1])+'"').join(""):""}createExternalLink(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return'<a href="'+this.escHTML(e)+'" target="_blank"'+this.createHTMLAttr(t)+">"+(r?this.prettyPrintURI(r):this.prettyPrintURI(e))+"</a>"}prettyPrintURI(e){return e.startsWith("schema:")?e.substring("schema:".length):this.escHTML(e)}createMainContent(e,r){return'<div id="mainContent" vocab="http://schema.org/" typeof="'+e+'" resource="'+window.location+'">'+r+"</div>"}underscore(e){return e.replace(/ /g,"_")}getTypeStructures(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"getSuperClasses",t=e[r](!1);if(0===t.length)return[[e.getIRI(!0)]];var n=[];return t.forEach(t=>{var a=this.browser.sdoAdapter.getTerm(t);this.getTypeStructures(a,r).forEach(r=>{r.push(e.getIRI(!0)),n.push(r)})}),n}createHeader(e,r){var t=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"",n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"",a=this.browser.term;return'<h1 property="rdfs:label" class="page-title">'+a.getIRI(!0)+"</h1>"+this.createSuperTypeBreadcrumbs(e,r,t,n)+'</h4><div property="rdfs:comment">'+a.getDescription()+"<br><br></div>"}createSuperTypeBreadcrumbs(e,r,t,n){return e?"<h4>"+e.map(e=>'<span class="breadcrumbs">'+t+e.map((t,a)=>{var i="";return(""===n&&a+2===e.length||""!==n&&a+1===e.length)&&(i+=this.createSemanticLink(r,t)),i+=this.createLink(t)}).join(" > ")+n+"</span>").join("<br>")+"</h4>":""}createSemanticLink(e,r){return'<link property="'+this.escHTML(e)+'" href="'+this.escHTML(this.createHref(r))+'">'}createHref(e){return this.isTermOfVocab(e)?this.createIRIwithQueryParam("term",e):this.browser.sdoAdapter.getTerm(e).getIRI()}isTermOfVocab(e){return this.browser.vocabs&&(this.browser.classes.includes(e)||this.browser.properties.includes(e)||this.browser.enumerations.includes(e)||this.browser.enumerationMembers.includes(e)||this.browser.dataTypes.includes(e))}createLink(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.isTermOfVocab(e)?this.createJSLink("a-term-name","term",e,null,r):this.createExternalLink(this.createHref(e),e,r)}createPropertyTableRow(e){var r=arguments.length>1&&void 0!==arguments[1]&&arguments[1];return this.createTableRow("rdfs:Property",this.createHref(e),"rdfs:label",this.createLink(e),this.createPropertySideCols(e,r),"prop-name")}createPropertySideCols(e,r){var t=this.browser.sdoAdapter.getProperty(e);return'<td class="prop-etc">'+this.createPropertyRange(t,r)+'</td><td class="prop-desc" property="rdfs:comment">'+t.getDescription()+"</td>"}createPropertyRange(e,r){var t="";return r||(t=e.getRanges(!1).map(e=>this.createSemanticLink("rangeIncludes",e)+this.createLink(e)).join("&nbsp; or <br>")),t+e.getDomains(!1).map(e=>this.createSemanticLink("domainIncludes",e)+(r?this.createLink(e):"")).join(r?"&nbsp; or <br>":"")}createDefinitionTable(e,r){return Array.isArray(e)||(e=[e]),Array.isArray(r)||(r=[r]),'<table class="definition-table"><thead><tr>'+e.map(e=>"<th>"+e+"</th>").join("")+"</tr></thead><tbody>"+(r[0].startsWith("<tr")?r.join(""):r.map(e=>"<tr>"+e+"</tr>").join(""))+"</tbody></table>"}createRangesOf(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],r=this.browser.term.isRangeOf(!1);if(0!==r.length){var t=r.map(e=>this.createPropertyTableRow(e,!0));return'<div id="incoming">Instances of '+this.createLink(this.browser.term.getIRI(!0))+(e?" and its enumeration members or subtypes":"")+" may appear as a value for the following properties</div><br>"+this.createDefinitionTable(["Property","On Types","Description"],t)}return""}}module.exports=Util;
