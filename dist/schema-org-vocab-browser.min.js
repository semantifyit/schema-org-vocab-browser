...
"use strict";function asyncGeneratorStep(e,t,r,a,s,n,o){try{var i=e[n](o),c=i.value}catch(e){return void r(e)}i.done?t(c):Promise.resolve(c).then(a,s)}function _asyncToGenerator(e){return function(){var t=this,r=arguments;return new Promise(function(a,s){var n=e.apply(t,r);function o(e){asyncGeneratorStep(n,a,s,o,i,"next",e)}function i(e){asyncGeneratorStep(n,a,s,o,i,"throw",e)}o(void 0)})}}class ListRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.createHeader()+this.createVocabsTable();this.browser.elem.innerHTML=this.util.createMainContent("schema:DataSet",e),this.addEventListener()}createHeader(){return"<h1>"+this.browser.list["schema:name"]+"</h1>"}createVocabsTable(){return'<table class="definition-table"><thead><tr><th>Name</th><th>IRI</th><th>Author</th><th>Description</th></tr></thead><tbody class="supertype">'+this.createVocabsTbody()+"</tbody></table>"}createVocabsTbody(){return this.browser.list["schema:hasPart"].map(e=>this.util.createTableRow("http://vocab.sti2.at/ds/Vocabulary",e["@id"],"schema:name",this.util.createJSLink("a-vocab-name","voc",e["@id"].split("/").pop(),e["schema:name"]||"No Name"),this.createVocabsSideCols(e))).join("")}createVocabsSideCols(e){return'<td property="@id">'+this.util.createExternalLink(e["@id"])+'</td><td property="schema:author">'+(e["schema:author"]&&e["schema:author"]["schema:name"]||"")+'</td><td property="schema:description">'+(e["schema:description"]||"")+"</td>"}addEventListener(){var e=this,t=document.getElementsByClassName("a-vocab-name"),r=function(t){t.addEventListener("click",_asyncToGenerator(function*(){history.pushState(null,null,t.href),yield e.browser.render()}))};for(var a of t)r(a)}}module.exports=ListRenderer;
