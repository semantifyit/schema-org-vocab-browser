...
"use strict";var util=require("./utilities"),Term=require("./Term");class EnumerationMember extends Term{constructor(e,r){super(e,r)}getTermType(){return"soa:EnumerationMember"}getTermObj(){return this.graph.enumerationMembers[this.IRI]}getDomainEnumerations(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=this.getTermObj(),i=[];if(i.push(...t["soa:enumerationDomainIncludes"]),e){var n=JSON.parse(JSON.stringify(i));for(var u of n)i.push(...this.graph.reasoner.inferSuperClasses(u));i=util.applyFilter(util.uniquifyArray(i),{termType:"Enumeration"},this.graph)}return util.applyFilter(util.uniquifyArray(i),r,this.graph)}toJSON(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=super.toJSON();return t.domainEnumerations=this.getDomainEnumerations(e,r),t}}module.exports=EnumerationMember;

},{"./Term":71,"./utilities":72}],67:[function(require,module,exports){
"use strict";function asyncGeneratorStep(e,s,r,a,t,i,o){try{var n=e[i](o),u=n.value}catch(e){return void r(e)}n.done?s(u):Promise.resolve(u).then(a,t)}function _asyncToGenerator(e){return function(){var s=this,r=arguments;return new Promise(function(a,t){var i=e.apply(s,r);function o(e){asyncGeneratorStep(i,a,t,o,n,"next",e)}function n(e){asyncGeneratorStep(i,a,t,o,n,"throw",e)}o(void 0)})}}var util=require("./utilities"),Class=require("./Class"),Property=require("./Property"),Enumeration=require("./Enumeration"),EnumerationMember=require("./EnumerationMember"),DataType=require("./DataType"),ReasoningEngine=require("./ReasoningEngine");class Graph{constructor(e){this.sdoAdapter=e,this.reasoner=new ReasoningEngine(this),this.context={rdf:"http://www.w3.org/1999/02/22-rdf-syntax-ns#",rdfs:"http://www.w3.org/2000/01/rdf-schema#",xsd:"http://www.w3.org/2001/XMLSchema#",dc:"http://purl.org/dc/terms/",schema:"http://schema.org/",soa:"http://schema-org-adapter.at/vocabTerms/","soa:superClassOf":{"@id":"soa:superClassOf","@type":"@id"},"soa:superPropertyOf":{"@id":"soa:superPropertyOf","@type":"@id"},"soa:hasProperty":{"@id":"soa:hasProperty","@type":"@id"},"soa:isRangeOf":{"@id":"soa:isRangeOf","@type":"@id"},"soa:hasEnumerationMember":{"@id":"soa:hasEnumerationMember","@type":"@id"},"soa:enumerationDomainIncludes":{"@id":"soa:enumerationDomainIncludes","@type":"@id"},"rdfs:subClassOf":{"@id":"rdfs:subClassOf","@type":"@id"},"rdfs:subPropertyOf":{"@id":"rdfs:subPropertyOf","@type":"@id"},"schema:isPartOf":{"@id":"schema:isPartOf","@type":"@id"},"schema:domainIncludes":{"@id":"schema:domainIncludes","@type":"@id"},"schema:rangeIncludes":{"@id":"schema:rangeIncludes","@type":"@id"},"schema:supersededBy":{"@id":"schema:supersededBy","@type":"@id"},"schema:inverseOf":{"@id":"schema:inverseOf","@type":"@id"},"dc:source":{"@id":"dc:source","@type":"@id"},"schema:source":{"@id":"schema:source","@type":"@id"}},this.classes={},this.properties={},this.dataTypes={},this.enumerations={},this.enumerationMembers={}}addVocabulary(e){var s=arguments,r=this;return _asyncToGenerator(function*(){var a=s.length>1&&void 0!==s[1]?s[1]:null;try{r.context=util.generateContext(r.context,e["@context"]),e=yield util.preProcessVocab(e,r.context);var t,i,o=r.sdoAdapter.getVocabularies();for(var n of e["@graph"])n=util.curateVocabNode(n,o);for(var u=0;u<e["@graph"].length;u++){var l=JSON.parse(JSON.stringify(e["@graph"][u]));if(util.isString(l["@type"]))switch(l["@type"]){case"rdfs:Class":r.addGraphNode(r.classes,l,a);break;case"rdf:Property":r.addGraphNode(r.properties,l,a);break;default:r.addGraphNode(r.enumerationMembers,l,a)}else util.isArray(l["@type"])?l["@type"].includes("rdfs:Class")&&l["@type"].includes("schema:DataType")?r.addGraphNode(r.dataTypes,l,a):r.addGraphNode(r.enumerationMembers,l,a):(console.log("unexpected @type format for the following node:"),console.log(JSON.stringify(l,null,2)))}do{t=!1;var f=Object.keys(r.classes),c=Object.keys(r.enumerations);for(var h of f)if(void 0!==r.classes[h]["rdfs:subClassOf"]){var p=r.classes[h]["rdfs:subClassOf"];for(var d of p)("schema:Enumeration"===d||c.includes(d))&&r.classes[h]&&!r.enumerations[h]&&(t=!0,r.enumerations[h]=JSON.parse(JSON.stringify(r.classes[h])),delete r.classes[h])}}while(t);do{i=!1;var m=Object.keys(r.classes),y=Object.keys(r.dataTypes);for(var v of m)if(void 0!==r.classes[v]["rdfs:subClassOf"]){var O=r.classes[v]["rdfs:subClassOf"];for(var b of O)("schema:DataType"===b||y.includes(b))&&r.classes[v]&&!r.dataTypes[v]&&(i=!0,r.dataTypes[v]=JSON.parse(JSON.stringify(r.classes[v])),delete r.classes[v])}}while(i);var g=Object.keys(r.dataTypes);for(var w of g)r.dataTypes[w]["@type"]="schema:DataType";var I=Object.keys(r.classes);for(var C of I){var P=r.classes[C]["rdfs:subClassOf"];for(var T of(r.classes[C]["soa:superClassOf"]||(r.classes[C]["soa:superClassOf"]=[]),P)){var E=r.classes[T];E||(E=r.enumerations[T]),E&&(E["soa:superClassOf"]?E["soa:superClassOf"].includes(C)||E["soa:superClassOf"].push(C):E["soa:superClassOf"]=[C])}}var R=Object.keys(r.enumerations);for(var M of R){var N=r.enumerations[M]["rdfs:subClassOf"];for(var k of(r.enumerations[M]["soa:superClassOf"]||(r.enumerations[M]["soa:superClassOf"]=[]),N)){var j=r.classes[k];j||(j=r.enumerations[k]),j&&(j["soa:superClassOf"]?j["soa:superClassOf"].includes(M)||j["soa:superClassOf"].push(M):j["soa:superClassOf"]=[M])}}var D=Object.keys(r.dataTypes);for(var x of D){var G=r.dataTypes[x]["rdfs:subClassOf"];if(r.dataTypes[x]["soa:superClassOf"]||(r.dataTypes[x]["soa:superClassOf"]=[]),G)for(var S of G){var L=r.dataTypes[S];L&&(L["soa:superClassOf"]?L["soa:superClassOf"].includes(x)||L["soa:superClassOf"].push(x):L["soa:superClassOf"]=[x])}else r.dataTypes[x]["rdfs:subClassOf"]=[]}var A=Object.keys(r.properties);for(var q of A){var J=r.properties[q]["rdfs:subPropertyOf"];if(r.properties[q]["soa:superPropertyOf"]||(r.properties[q]["soa:superPropertyOf"]=[]),J)for(var U of J){var F=r.properties[U];F&&(F["soa:superPropertyOf"]?F["soa:superPropertyOf"].includes(q)||F["soa:superPropertyOf"].push(q):F["soa:superPropertyOf"]=[q])}else r.properties[q]["rdfs:subPropertyOf"]=[]}for(var B of I=Object.keys(r.classes))r.classes[B]["soa:hasProperty"]||(r.classes[B]["soa:hasProperty"]=[]),r.classes[B]["soa:isRangeOf"]||(r.classes[B]["soa:isRangeOf"]=[]);for(var V of R=Object.keys(r.enumerations))r.enumerations[V]["soa:hasEnumerationMember"]||(r.enumerations[V]["soa:hasEnumerationMember"]=[]),r.enumerations[V]["soa:isRangeOf"]||(r.enumerations[V]["soa:isRangeOf"]=[]),r.enumerations[V]["soa:hasProperty"]||(r.enumerations[V]["soa:hasProperty"]=[]);for(var W of D=Object.keys(r.dataTypes))r.dataTypes[W]["soa:isRangeOf"]||(r.dataTypes[W]["soa:isRangeOf"]=[]);var _=Object.keys(r.enumerationMembers);for(var X of _)r.enumerationMembers[X]["soa:enumerationDomainIncludes"]||(r.enumerationMembers[X]["soa:enumerationDomainIncludes"]=[]);for(var z of A=Object.keys(r.properties)){var H=r.properties[z]["schema:domainIncludes"];if(util.isArray(H))for(var K of H){var Q=r.classes[K];Q||(Q=r.enumerations[K]),Q&&util.isArray(Q["soa:hasProperty"])&&!Q["soa:hasProperty"].includes(z)&&Q["soa:hasProperty"].push(z)}var Y=r.properties[z]["schema:rangeIncludes"];if(util.isArray(Y))for(var Z of Y){var $=r.classes[Z]||r.enumerations[Z]||r.dataTypes[Z];$&&util.isArray($["soa:isRangeOf"])&&!$["soa:isRangeOf"].includes(z)&&$["soa:isRangeOf"].push(z)}}for(var ee of _=Object.keys(r.enumerationMembers)){var se=r.enumerationMembers[ee],re=se["@type"];for(var ae of(util.isArray(re)||(re=[re]),re)){var te=r.enumerations[ae];te&&util.isArray(te["soa:hasEnumerationMember"])&&!te["soa:hasEnumerationMember"].includes(ee)&&(te["soa:hasEnumerationMember"].push(ee),util.isArray(se["soa:enumerationDomainIncludes"])?se["soa:enumerationDomainIncludes"].push(ae):se["soa:enumerationDomainIncludes"]=[ae])}}return!0}catch(e){return console.log(e),!1}})()}addGraphNode(e,s){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;try{if(e[s["@id"]]){var a=e[s["@id"]];if(util.isNil(s["schema:isPartOf"])||(a["schema:isPartOf"]=s["schema:isPartOf"]),util.isNil(s["dc:source"])||(a["dc:source"]=s["dc:source"]),util.isNil(s["schema:source"])||(a["schema:source"]=s["schema:source"]),util.isNil(s["schema:category"])||(a["schema:category"]=s["schema:category"]),util.isNil(s["schema:supersededBy"])||(a["schema:supersededBy"]=s["schema:supersededBy"]),!util.isNil(s["rdfs:label"])){var t=Object.keys(s["rdfs:label"]);for(var i of t)a["rdfs:label"][i]=s["rdfs:label"][i]}if(!util.isNil(s["rdfs:comment"])){var o=Object.keys(s["rdfs:comment"]);for(var n of o)a["rdfs:comment"][n]=s["rdfs:comment"][n]}if(!util.isNil(s["rdfs:subClassOf"]))for(var u of s["rdfs:subClassOf"])a["rdfs:subClassOf"].includes(u)||a["rdfs:subClassOf"].push(u);if(!util.isNil(s["soa:superClassOf"]))for(var l of s["soa:superClassOf"])a["soa:superClassOf"].includes(l)||a["soa:superClassOf"].push(l);if(!util.isNil(s["soa:hasProperty"]))for(var f of s["soa:hasProperty"])a["soa:hasProperty"].includes(f)||a["soa:hasProperty"].push(f);if(!util.isNil(s["soa:isRangeOf"]))for(var c of s["soa:isRangeOf"])a["soa:isRangeOf"].includes(c)||a["soa:isRangeOf"].push(c);if(!util.isNil(s["soa:enumerationDomainIncludes"]))for(var h of s["soa:enumerationDomainIncludes"])a["soa:enumerationDomainIncludes"].includes(h)||a["soa:enumerationDomainIncludes"].push(h);if(!util.isNil(s["soa:hasEnumerationMember"]))for(var p of s["soa:hasEnumerationMember"])a["soa:hasEnumerationMember"].includes(p)||a["soa:hasEnumerationMember"].push(p);if(!util.isNil(s["rdfs:subPropertyOf"]))for(var d of s["rdfs:subPropertyOf"])a["rdfs:subPropertyOf"].includes(d)||a["rdfs:subPropertyOf"].push(d);if(!util.isNil(s["schema:domainIncludes"]))for(var m of s["schema:domainIncludes"])a["schema:domainIncludes"].includes(m)||a["schema:domainIncludes"].push(m);if(!util.isNil(s["schema:rangeIncludes"]))for(var y of s["schema:rangeIncludes"])a["schema:rangeIncludes"].includes(y)||a["schema:rangeIncludes"].push(y);if(!util.isNil(s["schema:superPropertyOf"]))for(var v of s["schema:superPropertyOf"])a["schema:superPropertyOf"].includes(v)||a["schema:superPropertyOf"].push(v);r&&(a.vocabURLs?a.vocabURLs.includes(r)||a.vocabURLs.push(r):a.vocabURLs=[r])}else e[s["@id"]]=s,r&&(e[s["@id"]].vocabURLs=[r]);return!0}catch(e){return console.log(e),!1}}getTerm(e){var s,r,a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=this.discoverCompactIRI(e),i=0;do{switch(i){case 0:s=this.classes[t],r="Class";break;case 1:s=this.properties[t],r="Property";break;case 2:s=this.dataTypes[t],r="DataType";break;case 3:s=this.enumerations[t],r="Enumeration";break;case 4:s=this.enumerationMembers[t],r="EnumerationMember"}i++}while(!s&&i<6);if(!s)throw new Error("There is no term with the IRI "+e);if(0===(s=util.applyFilter([s["@id"]],a,this)).length)throw new Error("There is no term with that IRI and filter settings.");switch(r){case"Class":return new Class(t,this);case"Property":return new Property(t,this);case"Enumeration":return new Enumeration(t,this);case"EnumerationMember":return new EnumerationMember(t,this);case"DataType":return new DataType(t,this)}}getClass(e){var s=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.discoverCompactIRI(e);if(r){var a=this.classes[r];if(a){if(0===(a=util.applyFilter([r],s,this)).length)throw new Error("There is no class with that IRI and filter settings.");return new Class(r,this)}if(a=this.enumerations[r])try{return this.getEnumeration(r,s)}catch(e){throw new Error("There is no class with that IRI and filter settings.")}}throw new Error("There is no class with the IRI "+e)}getProperty(e){var s=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.discoverCompactIRI(e);if(r){var a=this.properties[r];if(a){if(0===(a=util.applyFilter([r],s,this)).length)throw new Error("There is no property with that URI and filter settings.");return new Property(r,this)}}throw new Error("There is no property with that URI.")}getDataType(e){var s=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.discoverCompactIRI(e);if(r){var a=this.dataTypes[r];if(a){if(0===(a=util.applyFilter([r],s,this)).length)throw new Error("There is no data-type with that IRI and filter settings.");return new DataType(r,this)}}throw new Error("There is no data-type with the IRI "+e)}getEnumeration(e){var s=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.discoverCompactIRI(e);if(r){var a=this.enumerations[r];if(a){if(0===(a=util.applyFilter([r],s,this)).length)throw new Error("There is no enumeration with that IRI and filter settings.");return new Enumeration(r,this)}}throw new Error("There is no enumeration with the IRI "+e)}getEnumerationMember(e){var s=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=this.discoverCompactIRI(e);if(r){var a=this.enumerationMembers[r];if(a){if(0===(a=util.applyFilter([r],s,this)).length)throw new Error("There is no EnumerationMember with that IRI and filter settings.");return new EnumerationMember(r,this)}}throw new Error("There is no EnumerationMember with the IRI "+e)}discoverCompactIRI(e){if(-1!==e.indexOf(":")){var s=Object.keys(this.context);for(var r of s){var a=this.context[r];if(util.isString(a)){if(e.startsWith(r))return e;if(e.startsWith(a))return util.toCompactIRI(e,this.context)}}}else{var t=Object.keys(this.classes);for(var i of t)if(!0===this.containsLabel(this.classes[i],e))return i;var o=Object.keys(this.properties);for(var n of o)if(!0===this.containsLabel(this.properties[n],e))return n;var u=Object.keys(this.dataTypes);for(var l of u)if(!0===this.containsLabel(this.dataTypes[l],e))return l;var f=Object.keys(this.enumerations);for(var c of f)if(!0===this.containsLabel(this.enumerations[c],e))return c;var h=Object.keys(this.enumerationMembers);for(var p of h)if(!0===this.containsLabel(this.enumerationMembers[p],e))return p}return null}containsLabel(e,s){if(e&&util.isObject(e["rdfs:label"])){var r=Object.keys(e["rdfs:label"]);for(var a of r)if(e["rdfs:label"][a]===s)return!0}return!1}}module.exports=Graph;
