...
"use strict";function asyncGeneratorStep(e,r,t,i,a,s,o){try{var n=e[s](o),h=n.value}catch(e){return void t(e)}n.done?r(h):Promise.resolve(h).then(i,a)}function _asyncToGenerator(e){return function(){var r=this,t=arguments;return new Promise(function(i,a){var s=e.apply(r,t);function o(e){asyncGeneratorStep(s,i,a,o,n,"next",e)}function n(e){asyncGeneratorStep(s,i,a,o,n,"throw",e)}o(void 0)})}}var Graph=require("./Graph"),util=require("./utilities"),axios=require("axios"),URI_SEMANTIFY_GITHUB="https://raw.githubusercontent.com/semantifyit/schemaorg/main/",URI_SEMANTIFY_RELEASES=URI_SEMANTIFY_GITHUB+"data/releases/",URI_SEMANTIFY_VERSIONS=URI_SEMANTIFY_GITHUB+"versions.json";class SDOAdapter{constructor(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;this.graph=new Graph(this),this.retrievalMemory={versionsFile:null,latest:null},this.commitBase=e}addVocabularies(e){var r=this;return _asyncToGenerator(function*(){if(util.isArray(e)||!util.isString(e)&&!util.isObject(e)||(e=[e]),!util.isArray(e))throw new Error("The first argument of the function must be an Array of vocabularies or a single vocabulary (JSON-LD as Object/String)");for(var t=0;t<e.length;t++)if(util.isString(e[t]))if(e[t].startsWith("www")||e[t].startsWith("http"))try{var i=yield r.fetchVocabularyFromURL(e[t]);yield r.graph.addVocabulary(i)}catch(r){throw new Error("The given URL "+e[t]+" did not contain a valid JSON-LD vocabulary.")}else try{yield r.graph.addVocabulary(JSON.parse(e[t]))}catch(e){throw new Error("Parsing of vocabulary string produced an invalid JSON-LD.")}else{if(!util.isObject(e[t]))throw new Error("The first argument of the function must be an Array of vocabularies or a single vocabulary (JSON-LD as Object/String)");yield r.graph.addVocabulary(e[t])}})()}fetchVocabularyFromURL(e){return _asyncToGenerator(function*(){return new Promise(function(r,t){axios.get(e).then(function(e){r(e.data)}).catch(function(e){t("Could not find any resource at the given URL.")})})})()}getTerm(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getTerm(e,r)}getAllTerms(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[],t=this.getListOfClasses(e),i=this.getListOfEnumerations(e),a=this.getListOfProperties(e),s=this.getListOfDataTypes(e),o=this.getListOfEnumerationMembers(e);for(var n of t)try{r.push(this.getClass(n))}catch(e){throw new Error("There is no class with the IRI "+n)}for(var h of i)try{r.push(this.getEnumeration(h))}catch(e){throw new Error("There is no enumeration with the IRI "+h)}for(var l of a)try{r.push(this.getProperty(l))}catch(e){throw new Error("There is no property with the IRI "+l)}for(var u of s)try{r.push(this.getDataType(u))}catch(e){throw new Error("There is no data type with the IRI "+u)}for(var c of o)try{r.push(this.getEnumerationMember(c))}catch(e){throw new Error("There is no enumeration member with the IRI "+c)}return r}getListOfTerms(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[];return r.push(...Object.keys(this.graph.classes)),r.push(...Object.keys(this.graph.enumerations)),r.push(...Object.keys(this.graph.properties)),r.push(...Object.keys(this.graph.dataTypes)),r.push(...Object.keys(this.graph.enumerationMembers)),util.applyFilter(r,e,this.graph)}getClass(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getClass(e,r)}getAllClasses(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[],t=this.getListOfClasses(e);for(var i of t)try{r.push(this.getClass(i))}catch(e){throw new Error("There is no class with the IRI "+i)}return r}getListOfClasses(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.classes),e,this.graph)}getProperty(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getProperty(e,r)}getAllProperties(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[],t=this.getListOfProperties(e);for(var i of t)try{r.push(this.getProperty(i))}catch(e){throw new Error("There is no property with the IRI "+i)}return r}getListOfProperties(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.properties),e,this.graph)}getDataType(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getDataType(e,r)}getAllDataTypes(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[],t=this.getListOfDataTypes(e);for(var i of t)try{r.push(this.getDataType(i))}catch(e){throw new Error("There is no data type with the IRI "+i)}return r}getListOfDataTypes(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.dataTypes),e,this.graph)}getEnumeration(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getEnumeration(e,r)}getAllEnumerations(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[],t=this.getListOfEnumerations(e);for(var i of t)try{r.push(this.getEnumeration(i))}catch(e){throw new Error("There is no enumeration with the IRI "+i)}return r}getListOfEnumerations(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.enumerations),e,this.graph)}getEnumerationMember(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getEnumerationMember(e,r)}getAllEnumerationMembers(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=[],t=this.getListOfEnumerationMembers(e);for(var i of t)try{r.push(this.getEnumerationMember(i))}catch(e){throw new Error("There is no enumeration member with the IRI "+i)}return r}getListOfEnumerationMembers(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.enumerationMembers),e,this.graph)}getVocabularies(){for(var e=Object.keys(this.graph.context),r={},t=["soa","xsd","rdf","rdfa","rdfs","dc"],i=0;i<e.length;i++)util.isString(this.graph.context[e[i]])&&-1===t.indexOf(e[i])&&(r[e[i]]=this.graph.context[e[i]]);return r}constructSDOVocabularyURL(){var e=arguments,r=this;return _asyncToGenerator(function*(){var t=e.length>0&&void 0!==e[0]?e[0]:"latest";if("latest"===t)try{r.retrievalMemory.versionsFile||(yield r.getSDOVersionFile()),t=r.retrievalMemory.latest}catch(e){throw console.error("Could not determine/retrieve the latest version of schema.org"),e}var i=util.getFileNameForSchemaOrgVersion(t);return r.getReleasesURI()+t+"/"+i})()}getSDOVersionFile(){var e=this;return _asyncToGenerator(function*(){var r;try{r=yield axios.get(e.getVersionFileURI())}catch(r){throw console.log("Unable to retrieve the schema.org versions file at "+e.getVersionFileURI()),r}if(r&&r.data){if(e.retrievalMemory.versionsFile=r.data,e.retrievalMemory.versionsFile.schemaversion){if(yield e.checkURL(yield e.constructSDOVocabularyURL(e.retrievalMemory.versionsFile.schemaversion)))e.retrievalMemory.latest=e.retrievalMemory.versionsFile.schemaversion;else{if(e.retrievalMemory.versionsFile.releaseLog){var t=util.sortReleaseEntriesByDate(e.retrievalMemory.versionsFile.releaseLog);for(var i of t)if(yield e.checkURL(yield e.constructSDOVocabularyURL(i[0]))){e.retrievalMemory.latest=i[0];break}}if(!e.retrievalMemory.latest){var a='Could not find any valid vocabulary file in the Schema.org versions file (to be declared as "latest".';throw console.log(a),new Error(a)}}return}var s="Schema.org versions file has an unexpected structure!";throw console.log(s+" -> "+e.getVersionFileURI()),new Error(s)}})()}checkURL(e){return _asyncToGenerator(function*(){try{return yield axios.head(e),!0}catch(e){return!1}})()}getLatestSDOVersion(){var e=this;return _asyncToGenerator(function*(){return e.retrievalMemory.latest||(yield e.getSDOVersionFile()),e.retrievalMemory.latest})()}getReleasesURI(){return this.commitBase?"https://raw.githubusercontent.com/schemaorg/schemaorg/"+this.commitBase+"/data/releases/":URI_SEMANTIFY_RELEASES}getVersionFileURI(){return this.commitBase?"https://raw.githubusercontent.com/schemaorg/schemaorg/"+this.commitBase+"/versions.json":URI_SEMANTIFY_VERSIONS}}module.exports=SDOAdapter;

},{"./Graph":75,"./utilities":80,"axios":1}],79:[function(require,module,exports){
"use strict";var util=require("./utilities");class Term{constructor(e,t){this.IRI=e,this.graph=t}getIRI(){return arguments.length>0&&void 0!==arguments[0]&&arguments[0]?this.IRI:util.toAbsoluteIRI(this.IRI,this.graph.context)}getTermType(){throw new Error("must be implemented by subclass!")}getTermObj(){throw new Error("must be implemented by subclass!")}getVocabulary(){var e=this.getTermObj();return util.isNil(e["schema:isPartOf"])?null:e["schema:isPartOf"]}getSource(){var e=this.getTermObj();return util.isNil(e["dc:source"])?util.isNil(e["schema:source"])?null:e["schema:source"]:e["dc:source"]}isSupersededBy(){var e=this.getTermObj();return util.isString(e["schema:supersededBy"])?e["schema:supersededBy"]:null}getName(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"en",t=this.getTermObj()["rdfs:label"];return util.isNil(t)||util.isNil(t[e])?null:t[e]}getDescription(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"en",t=this.getTermObj()["rdfs:comment"];return util.isNil(t)||util.isNil(t[e])?null:t[e]}toString(){return JSON.stringify(this.toJSON(!1,null),null,2)}toJSON(){var e={};return e.id=this.getIRI(!0),e.IRI=this.getIRI(),e.type=this.getTermType(),e.vocabulary=this.getVocabulary(),e.source=this.getSource(),e.supersededBy=this.isSupersededBy(),e.name=this.getName(),e.description=this.getDescription(),e}}module.exports=Term;
...
"use strict";class ClassRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.util.getTypeStructure(this.browser.term),t=this.util.createHeader(e,"rdfs:subClassOf")+this.createProperties();this.browser.elem.innerHTML=this.util.createMainContent("rdfs:Class",t)}createProperties(){var e='<table class="definition-table">'+this.createPropertiesHeader();return[this.browser.term,...this.browser.term.getSuperClasses().map(e=>this.browser.sdoAdapter.getClass(e))].forEach(t=>{var r=t.getProperties(!1);0!==r.length&&(e+="<tbody>"+this.createPropertyHeader(t),r.forEach(t=>{e+=this.util.createPropertyTableRow(t)}),e+="</tbody>")}),e+="</table><br>"+this.createSpecificTypes()}createPropertiesHeader(){return"<thead><tr><th>Property</th><th>Expected Type</th><th>Description</th></tr></thead>"}createPropertyHeader(e){return'<tbody><tr class="supertype"><th class="supertype-name" colspan="3">Properties from '+this.util.createLink(e.getIRI(!0))+"</th></tr></tbody>"}createSpecificTypes(){var e=this.browser.term.getSubClasses(!1);return 0!==e.length?'<b><a id="subtypes" title="Link: #subtypes" href="#subtypes" class="clickableAnchor">More specific Types</a></b><ul>'+e.map(e=>"<li>"+this.util.createLink(e)+"</li>")+"</ul><br>":""}}module.exports=ClassRenderer;

},{}],85:[function(require,module,exports){
"use strict";class DataTypeRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.util.createFullLink("schema:DataType",null,"rdfs:subClassOf")+" > ",t=this.util.getTypeStructure(this.browser.term,"getSuperDataTypes"),r=this.util.createHeader(t,"",e)+this.util.createRangesOf();this.browser.elem.innerHTML=this.util.createMainContent("rdfs:Class",r)}}module.exports=DataTypeRenderer;

},{}],86:[function(require,module,exports){
"use strict";class EnumerationMemberRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.browser.term.getDomainEnumerations().flatMap(e=>this.util.getTypeStructure(this.browser.sdoAdapter.getClass(e))),t=" :: "+this.util.createLink(this.browser.term.getIRI(!0)),r=this.util.createHeader(e,"@type","",t)+this.createDomains();this.browser.elem.innerHTML=this.util.createMainContent("rdfs:Class",r)}createDomains(){var e=this.browser.term.getDomainEnumerations();return"A member value for enumeration"+(e.length>1?"s":"")+": "+e.map(e=>this.util.createLink(e)).join(", ")+"<br>"}}module.exports=EnumerationMemberRenderer;

},{}],87:[function(require,module,exports){
"use strict";class EnumerationRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.util.getTypeStructure(this.browser.term),r=this.util.createHeader(e,"rdfs:subClassOf")+this.createEnumerationMembers()+this.util.createRangesOf(!0);this.browser.elem.innerHTML=this.util.createMainContent("rdfs:Class",r)}createEnumerationMembers(){var e=this.browser.term.getEnumerationMembers();return 0!==e.length?'An Enumeration with:<br><b><a id="enumbers" title="Link: #enumbers" href="#enumbers" class="clickableAnchor">Enumeration members</a></b><ul>'+e.map(e=>"<li>"+this.util.createLink(e)+"</li>").join("")+"</ul><br>":""}}module.exports=EnumerationRenderer;

},{}],88:[function(require,module,exports){
"use strict";class ListRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.createHeader()+this.createVocabsTable();this.browser.elem.innerHTML=this.util.createMainContent("schema:DataSet",e)}createHeader(){return"<h1>"+this.browser.list["schema:name"]+"</h1>"+this.util.createExternalLinkLegend()+this.browser.list["schema:description"]||""}createVocabsTable(){return this.util.createDefinitionTable(["Name","IRI","Author","Description"],this.createVocabsTbody(),{class:"supertype"})}createVocabsTbody(){return this.browser.list["schema:hasPart"].map(e=>this.util.createTableRow("http://vocab.sti2.at/ds/Vocabulary",e["@id"],"schema:name",this.util.createJSLink("voc",e["@id"].split("/").pop(),e["schema:name"]||"No Name"),this.createVocabsSideCols(e))).join("")}createVocabsSideCols(e){return'<td property="@id">'+this.util.createExternalLink(e["@id"])+'</td><td property="schema:author">'+(e["schema:author"]&&e["schema:author"]["schema:name"]||"")+'</td><td property="schema:description">'+(e["schema:description"]||"")+"</td>"}}module.exports=ListRenderer;

},{}],89:[function(require,module,exports){
"use strict";class PropertyRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.createStartBreadcrumbs(),t=this.util.getTypeStructure(this.browser.term,"getSuperProperties"),r=this.util.createHeader(t,"rdfs:subPropertyOf",e)+this.createRanges()+this.createDomainIncludes()+this.createSuperproperties()+this.createSubproperties();this.browser.elem.innerHTML=this.util.createMainContent("rdf:Property",r)}createStartBreadcrumbs(){return this.util.createLink("schema:Thing")+" > "+this.util.createLink("schema:Property",{title:"Defined in section: meta.schema.org"})+" > "}createRanges(){var e=this.browser.term.getRanges(!1).map(e=>{var t={title:"The '"+this.browser.term.getIRI(!0)+"' property has values that include instances of the '"+e+"' type."};return this.util.createCodeLink(e,null,t,"rangeIncludes")}).join("<br>");return this.util.createDefinitionTable("Values expected to be one of these types","<td>"+e+"</td>")}createDomainIncludes(){var e=this.browser.term.getDomains(!1).map(e=>{var t={title:"The '"+this.browser.term.getIRI(!0)+"' property is used on the '"+e+"' type"};return this.util.createCodeLink(e,null,t,"domainIncludes")}).join("<br>");return this.util.createDefinitionTable("Used on these types","<td>"+e+"</td>")}createSuperproperties(){var e=this.browser.term.getSuperProperties(!1);return this.createRelatedProperties(e,"Super-properties")}createRelatedProperties(e,t){if(0!==e.length){var r=e.map(e=>{var t={title:e+": ''"+(this.browser.sdoAdapter.getProperty(e).getDescription()||"")+"''"};return this.util.createCodeLink(e,null,t)}).join("<br>");return this.util.createDefinitionTable(t,"<td>"+r+"</td>")}return""}createSubproperties(){var e=this.browser.term.getSubProperties(!1);return this.createRelatedProperties(e,"Sub-properties")}}module.exports=PropertyRenderer;

},{}],90:[function(require,module,exports){
"use strict";var _schemaOrgAdapter=_interopRequireDefault(require("schema-org-adapter")),_Util=_interopRequireDefault(require("./Util")),_ListRenderer=_interopRequireDefault(require("./ListRenderer")),_VocabRenderer=_interopRequireDefault(require("./VocabRenderer")),_ClassRenderer=_interopRequireDefault(require("./ClassRenderer")),_PropertyRenderer=_interopRequireDefault(require("./PropertyRenderer")),_EnumerationRenderer=_interopRequireDefault(require("./EnumerationRenderer")),_EnumerationMemberRenderer=_interopRequireDefault(require("./EnumerationMemberRenderer")),_DataTypeRenderer=_interopRequireDefault(require("./DataTypeRenderer"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function asyncGeneratorStep(e,r,t,n,a,i,s){try{var o=e[i](s),d=o.value}catch(e){return void t(e)}o.done?r(d):Promise.resolve(d).then(n,a)}function _asyncToGenerator(e){return function(){var r=this,t=arguments;return new Promise(function(n,a){var i=e.apply(r,t);function s(e){asyncGeneratorStep(i,n,a,s,o,"next",e)}function o(e){asyncGeneratorStep(i,n,a,s,o,"throw",e)}s(void 0)})}}var BROWSER_TYPES={VOCAB:"VOCAB",LIST:"LIST"};class SDOVocabBrowser{constructor(e,r){var t=this,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:BROWSER_TYPES.VOCAB;this.elem=e,this.vocabOrList=r,this.type=n,this.util=new _Util.default(this),this.listRenderer=new _ListRenderer.default(this),this.vocabRenderer=new _VocabRenderer.default(this),this.classRenderer=new _ClassRenderer.default(this),this.propertyRenderer=new _PropertyRenderer.default(this),this.enumerationRenderer=new _EnumerationRenderer.default(this),this.enumerationMemberRenderer=new _EnumerationMemberRenderer.default(this),this.dataTypeRenderer=new _DataTypeRenderer.default(this),window.addEventListener("popstate",_asyncToGenerator(function*(){yield t.render()}))}render(){var e=this;return _asyncToGenerator(function*(){if(e.elem.innerHTML='<img src="https://raw.githubusercontent.com/semantifyit/schema-org-vocab-browser/main/images/loading.gif" alt="Loading Animation" style="margin-top: 6px">',yield e.init(),e.isListRendering())e.listRenderer.render();else if(e.isVocabRendering()){var r=new URLSearchParams(window.location.search).get("format");r&&"jsonld"===r?e.vocabRenderer.renderJsonld():e.vocabRenderer.render()}else e.isTermRendering()&&e.renderTerm();e.addJSLinkEventListener(),document.body.scrollTop=document.documentElement.scrollTop=0})()}init(){var e=this;return _asyncToGenerator(function*(){e.listNeedsInit()&&(yield e.initList()),e.vocabNeedsInit()&&(yield e.initVocab())})()}listNeedsInit(){return this.type===BROWSER_TYPES.LIST&&!this.list}initList(){var e=this;return _asyncToGenerator(function*(){e.list=yield e.util.parseToObject(e.vocabOrList)})()}vocabNeedsInit(){var e=new URLSearchParams(window.location.search).get("voc");return this.type===BROWSER_TYPES.LIST&&e&&e!==this.vocUID||this.type===BROWSER_TYPES.VOCAB&&!this.vocab}initVocab(){var e=this;return _asyncToGenerator(function*(){if(e.type===BROWSER_TYPES.VOCAB)e.vocab=yield e.util.parseToObject(e.vocabOrList);else if(e.type===BROWSER_TYPES.LIST){var r=new URLSearchParams(window.location.search);for(var t of(e.vocUID=r.get("voc"),e.list["schema:hasPart"])){var n=t["@id"];if(n.split("/").pop()===e.vocUID){e.vocab=yield e.util.parseToObject(n),e.vocName=t["schema:name"];break}}}yield e.initSDOAdapter()})()}initSDOAdapter(){var e=this;return _asyncToGenerator(function*(){e.sdoAdapter=new _schemaOrgAdapter.default;var r=yield e.sdoAdapter.constructSDOVocabularyURL("latest");yield e.sdoAdapter.addVocabularies([r,e.vocab]),e.namespaces=e.sdoAdapter.getVocabularies(),delete e.namespaces.schema;var t=Object.keys(e.namespaces);e.classes=e.sdoAdapter.getListOfClasses({fromVocabulary:t}),e.properties=e.sdoAdapter.getListOfProperties({fromVocabulary:t}),e.enumerations=e.sdoAdapter.getListOfEnumerations({fromVocabulary:t}),e.enumerationMembers=e.sdoAdapter.getListOfEnumerationMembers({fromVocabulary:t}),e.dataTypes=e.sdoAdapter.getListOfDataTypes({fromVocabulary:t})})()}isListRendering(){var e=new URLSearchParams(window.location.search);return this.type===BROWSER_TYPES.LIST&&!e.get("voc")}isVocabRendering(){var e=new URLSearchParams(window.location.search);return this.type===BROWSER_TYPES.LIST&&e.get("voc")&&!e.get("term")||this.type===BROWSER_TYPES.VOCAB&&!e.get("term")}isTermRendering(){return null!==new URLSearchParams(window.location.search).get("term")}renderTerm(){var e=new URLSearchParams(window.location.search);switch(this.term=this.sdoAdapter.getTerm(e.get("term")),this.term.getTermType()){case"rdfs:Class":this.classRenderer.render();break;case"rdf:Property":this.propertyRenderer.render();break;case"schema:Enumeration":this.enumerationRenderer.render();break;case"soa:EnumerationMember":this.enumerationMemberRenderer.render();break;case"schema:DataType":this.dataTypeRenderer.render()}}addJSLinkEventListener(){var e=this,r=this.elem.getElementsByClassName("a-js-link"),t=function(r){r.addEventListener("click",function(){var t=_asyncToGenerator(function*(t){t.ctrlKey?window.open(r.href):(history.pushState(null,null,r.href),yield e.render())});return function(e){return t.apply(this,arguments)}}())};for(var n of r)t(n)}}module.exports=SDOVocabBrowser;
...
"use strict";function asyncGeneratorStep(e,t,r,n,a,i,s){try{var o=e[i](s),c=o.value}catch(e){return void r(e)}o.done?t(c):Promise.resolve(c).then(n,a)}function _asyncToGenerator(e){return function(){var t=this,r=arguments;return new Promise(function(n,a){var i=e.apply(t,r);function s(e){asyncGeneratorStep(i,n,a,s,o,"next",e)}function o(e){asyncGeneratorStep(i,n,a,s,o,"throw",e)}s(void 0)})}}class Util{constructor(e){this.browser=e}parseToObject(e){var t=this;return _asyncToGenerator(function*(){var r;return t.isString(e)?(r=t.isValidUrl(e)?yield t.getJsonld(e):e,JSON.parse(r)):e})()}isString(e){return"string"==typeof e||e instanceof String}isValidUrl(e){try{new URL(e)}catch(e){return!1}return!0}getJsonld(e){return new Promise(function(t,r){var n=new XMLHttpRequest;n.open("GET",e),n.setRequestHeader("Accept","application/ld+json"),n.onload=function(){this.status>=200&&this.status<300?t(n.response):r({status:this.status,statusText:n.statusText})},n.onerror=function(){r({status:this.status,statusText:n.statusText})},n.send()})}createIriWithQueryParam(e,t){var r=new URLSearchParams(window.location.search);t&&""!==t?r.set(e,t):r.delete(e);var n=r.toString();return window.location.protocol+"//"+(window.location.host?window.location.host:"")+window.location.pathname+(""!==n?"?"+n:"")}createTableRow(e,t,r,n,a){var i=arguments.length>5&&void 0!==arguments[5]?arguments[5]:null;return'<tr typeof="'+e+'" resource="'+t+'">'+this.createMainCol(r,n,i)+a+"</tr>"}createMainCol(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return"<th"+(r?' class="'+r+'"':"")+' scope="row">'+this.createCodeLink(t,{property:e})+"</th>"}createCodeLink(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;return"<code"+this.createHtmlAttr(t)+">"+this.createFullLink(e,r,n)+"</code>"}createFullLink(e,t,r){var n=null;try{n=this.browser.sdoAdapter.getTerm(e)}catch(e){}return""+(r?this.createSemanticLink(r,e):"")+(n?this.createLink(e,t):e)}createJSLink(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null,a=this.createIriWithQueryParam(e,t);return'<a class="a-js-link" href="'+this.escHtml(a)+'" onclick="return false;"'+this.createHtmlAttr(n)+">"+(r?this.escHtml(r):this.escHtml(t))+"</a>"}escHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}createHtmlAttr(e){return e?Object.entries(e).map(e=>" "+this.escHtml(e[0])+'="'+this.escHtml(e[1])+'"').join(""):""}createExternalLink(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,n=new URL(e);if(window.location.hostname!==n.hostname){var a=" "+this.createExternalLinkStyle(e);r?r.hasOwnProperty("style")?r.style=r.style+a:r.style=a:r={style:a}}return'<a href="'+this.escHtml(e)+'" target="_blank"'+this.createHtmlAttr(r)+">"+(t?this.prettyPrintIri(t):this.prettyPrintIri(e))+"</a>"}createExternalLinkStyle(e){var t="background-position: center right; background-repeat: no-repeat; background-size: 10px 10px; padding-right: 13px; ";return-1===e.indexOf("https://schema.org")&&-1===e.indexOf("http://schema.org")?t+="background-image: url(https://raw.githubusercontent.com/semantifyit/schema-org-vocab-browser/main/images/external-link-icon-blue.png);":t+="background-image: url(https://raw.githubusercontent.com/semantifyit/schema-org-vocab-browser/main/images/external-link-icon-red.png);",t}prettyPrintIri(e){return e.replace(/^(schema:|https?:\/\/schema.org\/)(.+)/,"$2")}createMainContent(e,t){return'<div id="mainContent" vocab="http://schema.org/" typeof="'+e+'" resource="'+window.location+'">'+t+"</div>"}underscore(e){return e.replace(/ /g,"_")}getTypeStructure(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"getSuperClasses",r=e[t](!1);if(0===r.length)return[[e.getIRI(!0)]];var n=[];return r.forEach(r=>{var a=this.browser.sdoAdapter.getTerm(r);this.getTypeStructure(a,t).forEach(t=>{t.push(e.getIRI(!0)),n.push(t)})}),n}createHeader(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"",n=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"",a=this.browser.term;return'<span style="float: right;">'+(this.browser.vocName?"(from Vocabulary: "+this.createJSLink("term",null,this.browser.vocName)+")":"(go to "+this.createJSLink("term",null,"Vocabulary")+")")+'</span><h1 property="rdfs:label" class="page-title">'+a.getIRI(!0)+"</h1>"+this.createExternalLinkLegend()+this.createTypeStructureBreadcrumbs(e,t,r,n)+'<div property="rdfs:comment">'+(a.getDescription()||"")+"<br><br></div>"}createExternalLinkLegend(){return'<p style="font-size: 12px; margin-top: 0">(<span style="'+("margin-right: 3px; "+this.createExternalLinkStyle(""))+'"></span>External link<span style="'+("margin-right: 3px; "+this.createExternalLinkStyle("https://schema.org")+" margin-left: 6px;")+'"></span>External link to schema.org )</p>'}createTypeStructureBreadcrumbs(e,t,r,n){return"<h4>"+e.map(e=>'<span class="breadcrumbs">'+r+e.map((r,a)=>{var i="";return(""===n&&a+2===e.length||""!==n&&a+1===e.length)&&(i+=this.createSemanticLink(t,r)),i+=this.createLink(r)}).join(" > ")+n+"</span>").join("<br>")+"</h4>"}createSemanticLink(e,t){return'<link property="'+this.escHtml(e)+'" href="'+this.escHtml(this.createHref(t))+'">'}createHref(e){return this.isTermOfVocab(e)?this.createIriWithQueryParam("term",e):this.browser.sdoAdapter.getTerm(e).getIRI()}isTermOfVocab(e){return this.browser.vocab&&(this.browser.classes.includes(e)||this.browser.properties.includes(e)||this.browser.enumerations.includes(e)||this.browser.enumerationMembers.includes(e)||this.browser.dataTypes.includes(e))}createLink(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.isTermOfVocab(e)?this.createJSLink("term",e,null,t):this.createExternalLink(this.createHref(e),e,t)}createPropertyTableRow(e){var t=arguments.length>1&&void 0!==arguments[1]&&arguments[1];return this.createTableRow("rdfs:Property",this.createHref(e),"rdfs:label",this.createLink(e),this.createPropertySideCols(e,t),"prop-name")}createPropertySideCols(e,t){var r=this.browser.sdoAdapter.getProperty(e);return'<td class="prop-etc">'+this.createPropertyRange(r,t)+'</td><td class="prop-desc" property="rdfs:comment">'+(r.getDescription()||"")+"</td>"}createPropertyRange(e,t){var r="";return t||(r=e.getRanges(!1).map(e=>this.createSemanticLink("rangeIncludes",e)+this.createLink(e)).join("&nbsp; or <br>")),r+e.getDomains(!1).map(e=>this.createSemanticLink("domainIncludes",e)+(t?this.createLink(e):"")).join(t?"&nbsp; or <br>":"")}createDefinitionTable(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return Array.isArray(e)||(e=[e]),Array.isArray(t)||(t=[t]),'<table class="definition-table"><thead><tr>'+e.map(e=>"<th>"+e+"</th>").join("")+"</tr></thead><tbody"+this.createHtmlAttr(r)+">"+(t[0].startsWith("<tr")?t.join(""):t.map(e=>"<tr>"+e+"</tr>").join(""))+"</tbody></table>"}createRangesOf(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],t=this.browser.term.isRangeOf(!1);if(0!==t.length){var r=t.map(e=>this.createPropertyTableRow(e,!0));return'<div id="incoming">Instances of '+this.createLink(this.browser.term.getIRI(!0))+(e?" and its enumeration members or subtypes":"")+" may appear as a value for the following properties</div><br>"+this.createDefinitionTable(["Property","On Types","Description"],r)}return""}}module.exports=Util;

},{}],92:[function(require,module,exports){
"use strict";var TYPES_PLURAL={Class:"Classes",Property:"Properties",Enumeration:"Enumerations","Enumeration Member":"Enumeration Members","Data Type":"Data Types"};class VocabRenderer{constructor(e){this.browser=e,this.util=this.browser.util}renderJsonld(){this.browser.elem.innerHTML='<pre style="font-size: medium; background: none; text-align: left; width: auto; padding: 0; overflow: visible; color: rgb(0, 0, 0); line-height: normal; display: block; font-family: monospace; margin: 1em 0; word-wrap: break-word; white-space: pre-wrap;">'+JSON.stringify(this.browser.vocab,null,2)+"</pre>"}render(){var e=this.createHeading()+this.createNamespaces()+this.createContentSection()+this.createSection(this.browser.classes,"Class")+this.createSection(this.browser.properties,"Property")+this.createSection(this.browser.enumerations,"Enumeration")+this.createSection(this.browser.enumerationMembers,"Enumeration Member")+this.createSection(this.browser.dataTypes,"Data Type");this.browser.elem.innerHTML=this.util.createMainContent("schema:DataSet",e)}createHeading(){return'<span style="float: right;">('+this.util.createJSLink("format","jsonld","JSON-LD serialization")+(this.browser.list?" | from List: "+this.util.createJSLink("voc",null,this.browser.list["schema:name"]):"")+")</span><h1>"+(this.browser.vocName?this.browser.vocName:"Vocabulary")+"</h1>"+this.util.createExternalLinkLegend()}createNamespaces(){return'<h2 style="margin: revert;">Namespaces</h2><ul>'+Object.entries(this.browser.namespaces).map(e=>"<li>"+e[0]+": "+this.util.createExternalLink(e[1])+"</li>").join("")+"</ul>"}createContentSection(){return'<h2 style="margin: revert;">Content</h2><ul>'+this.createContentListElement(this.browser.classes,"Class")+this.createContentListElement(this.browser.properties,"Property")+this.createContentListElement(this.browser.enumerations,"Enumeration")+this.createContentListElement(this.browser.enumerationMembers,"Enumeration Member")+this.createContentListElement(this.browser.dataTypes,"Data Type")+"</ul>"}createContentListElement(e,t){if(0!==e.length){var r=TYPES_PLURAL[t];return'<li><a href="#'+this.util.underscore(r)+'">'+e.length+" "+(1===e.length?t:r)+"</a></li>"}return""}createSection(e,t){if(0!==e.length){var r=TYPES_PLURAL[t];return'<h2 id="'+this.util.underscore(r)+'">'+r+"</h2>"+this.util.createDefinitionTable([t,"Description"],this.createSectionTbody(e),{class:"supertype"})}return""}createSectionTbody(e){return e.map(e=>{var t=this.browser.sdoAdapter.getTerm(e);return this.util.createTableRow(t.getTermType(),this.util.createIriWithQueryParam("term",e),"@id",this.util.createJSLink("term",e),'<td property="rdfs:comment">'+(t.getDescription()||"")+"</td>")}).join("")}}module.exports=VocabRenderer;
