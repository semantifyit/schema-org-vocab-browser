...
"use strict";class ClassRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.util.getTypeStructures(this.browser.term),t=this.util.createHeader(e,"rdfs:subClassOf")+this.createProperties();this.browser.elem.innerHTML=this.util.createMainContent("rdfs:Class",t)}createProperties(){var e='<table class="definition-table">'+this.createPropertiesHeader();return[this.browser.term,...this.browser.term.getSuperClasses().map(e=>this.browser.sdoAdapter.getClass(e))].forEach(t=>{var r=t.getProperties(!1);0!==r.length&&(e+="<tbody>"+this.createPropertyHeader(t),r.forEach(t=>{e+=this.util.createPropertyTableRow(t)}),e+="</tbody>")}),e+="</table><br>"+this.createSpecificTypes()}createPropertiesHeader(){return"<thead><tr><th>Property</th><th>Expected Type</th><th>Description</th></tr></thead>"}createPropertyHeader(e){return'<tbody><tr class="supertype"><th class="supertype-name" colspan="3">Properties from '+this.util.createLink(e.getIRI(!0))+"</th></tr></tbody>"}createSpecificTypes(){var e=this.browser.term.getSubClasses(!1);return 0!==e.length?'<browser><a id="subtypes" title="Link: #subtypes" href="#subtypes" class="clickableAnchor">More specific Types</a></browser><ul>'+e.map(e=>"<li>"+this.util.createLink(e)+"</li>")+"</ul><br>":""}}module.exports=ClassRenderer;

},{}],84:[function(_dereq_,module,exports){
"use strict";class DataTypeRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.util.createFullLink("schema:DataType",null,"rdfs:subClassOf")+" > ",t=""+this.util.createHeader(this.util.getTypeStructures(this.browser.term,"getSuperDataTypes"),"",e)+this.util.createRangesOf();this.browser.elem.innerHTML=this.util.createMainContent("rdfs:Class",t)}}module.exports=DataTypeRenderer;

},{}],85:[function(_dereq_,module,exports){
"use strict";class EnumerationMemberRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.browser.term.getDomainEnumerations().flatMap(e=>this.util.getTypeStructures(this.browser.sdoAdapter.getClass(e))),t=" :: "+this.util.createLink(this.browser.term.getIRI(!0)),r=this.util.createHeader(e,"@type","",t)+this.createDomains();this.browser.elem.innerHTML=this.util.createMainContent("rdfs:Class",r)}createDomains(){var e=this.browser.term.getDomainEnumerations();return"A member value for enumeration"+(e.length>1?"s":"")+": "+e.map(e=>this.util.createLink(e)).join(", ")+"<br>"}}module.exports=EnumerationMemberRenderer;

},{}],86:[function(_dereq_,module,exports){
"use strict";class EnumerationRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.util.createHeader(this.util.getTypeStructures(this.browser.term),"rdfs:subClassOf")+this.createEnumerationMembers()+this.util.createRangesOf(!0);this.browser.elem.innerHTML=this.util.createMainContent("rdfs:Class",e)}createEnumerationMembers(){var e=this.browser.term.getEnumerationMembers();return 0!==e.length?'An Enumeration with:<br><browser><a id="enumbers" title="Link: #enumbers" href="#enumbers" class="clickableAnchor">Enumeration members</a></browser><ul>'+e.map(e=>"<li>"+this.util.createLink(e)+"</li>").join("")+"</ul><br>":""}}module.exports=EnumerationRenderer;

},{}],87:[function(_dereq_,module,exports){
"use strict";class ListRenderer{constructor(t){this.browser=t,this.util=this.browser.util}render(){var t=this.createHeader()+this.createVocabsTable();this.browser.elem.innerHTML=this.util.createMainContent("schema:DataSet",t)}createHeader(){return"<h1>"+this.browser.list["schema:name"]+"</h1>"}createVocabsTable(){return'<table class="definition-table"><thead><tr><th>Name</th><th>IRI</th><th>Author</th><th>Description</th></tr></thead><tbody class="supertype">'+this.createVocabsTbody()+"</tbody></table>"}createVocabsTbody(){return this.browser.list["schema:hasPart"].map(t=>this.util.createTableRow("http://vocab.sti2.at/ds/Vocabulary",t["@id"],"schema:name",this.util.createJSLink("voc",t["@id"].split("/").pop(),t["schema:name"]||"No Name"),this.createVocabsSideCols(t))).join("")}createVocabsSideCols(t){return'<td property="@id">'+this.util.createExternalLink(t["@id"])+'</td><td property="schema:author">'+(t["schema:author"]&&t["schema:author"]["schema:name"]||"")+'</td><td property="schema:description">'+(t["schema:description"]||"")+"</td>"}}module.exports=ListRenderer;

},{}],88:[function(_dereq_,module,exports){
"use strict";class PropertyRenderer{constructor(e){this.browser=e,this.util=this.browser.util}render(){var e=this.createStartBreadcrumbs(),t=this.util.getTypeStructures(this.browser.term,"getSuperProperties"),r=this.util.createHeader(t,"rdfs:subPropertyOf",e)+this.createRanges()+this.createDomainIncludes()+this.createSuperProperties()+this.createSubProperties();this.browser.elem.innerHTML=this.util.createMainContent("rdf:Property",r)}createStartBreadcrumbs(){return this.util.createLink("schema:Thing")+" > "+this.util.createLink("schema:Property",{title:"Defined in section: meta.schema.org"})+" > "}createRanges(){var e=this.browser.term.getRanges(!1).map(e=>{var t={title:"The '"+this.browser.term.getIRI(!0)+"' property has values that include instances of the '"+e+"' type."};return this.util.createCodeLink(e,null,t,"rangeIncludes")}).join("<br>");return this.util.createDefinitionTable("Values expected to be one of these types","<td>"+e+"</td>")}createDomainIncludes(){var e=this.browser.term.getDomains(!1).map(e=>{var t={title:"The '"+this.browser.term.getIRI(!0)+"' property is used on the '"+e+"' type"};return this.util.createCodeLink(e,null,t,"domainIncludes")}).join("<br>");return this.util.createDefinitionTable("Used on these types","<td>"+e+"</td>")}createSuperProperties(){var e=this.browser.term.getSuperProperties(!1);return this.createRelationship(e,"Super-properties")}createRelationship(e,t){if(0!==e.length){var r=e.map(e=>{var t={title:e+": ''"+(this.browser.sdoAdapter.getProperty(e).getDescription()||"")+"''"};return this.util.createCodeLink(e,null,t)}).join("<br>");return this.util.createDefinitionTable(t,"<td>"+r+"</td>")}return""}createSubProperties(){var e=this.browser.term.getSubProperties(!1);return this.createRelationship(e,"Sub-properties")}}module.exports=PropertyRenderer;

},{}],89:[function(_dereq_,module,exports){
"use strict";function asyncGeneratorStep(e,r,t,n,a,i,s){try{var o=e[i](s),d=o.value}catch(e){return void t(e)}o.done?r(d):Promise.resolve(d).then(n,a)}function _asyncToGenerator(e){return function(){var r=this,t=arguments;return new Promise(function(n,a){var i=e.apply(r,t);function s(e){asyncGeneratorStep(i,n,a,s,o,"next",e)}function o(e){asyncGeneratorStep(i,n,a,s,o,"throw",e)}s(void 0)})}}var SDOAdapter=_dereq_("schema-org-adapter"),Util=_dereq_("./Util"),ListRenderer=_dereq_("./ListRenderer"),VocabRenderer=_dereq_("./VocabRenderer"),ClassRenderer=_dereq_("./ClassRenderer"),PropertyRenderer=_dereq_("./PropertyRenderer"),EnumerationRenderer=_dereq_("./EnumerationRenderer"),EnumerationMemberRenderer=_dereq_("./EnumerationMemberRenderer"),DataTypeRenderer=_dereq_("./DataTypeRenderer"),TYPES={VOCAB:"VOCAB",LIST:"LIST"};class SDOVocabBrowser{constructor(e,r){var t=this,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:TYPES.VOCAB;this.elem=e,this.vocabOrVocabList=r,this.type=n,this.util=new Util(this),this.listRenderer=new ListRenderer(this),this.vocabRenderer=new VocabRenderer(this),this.classRenderer=new ClassRenderer(this),this.propertyRenderer=new PropertyRenderer(this),this.enumerationRenderer=new EnumerationRenderer(this),this.enumerationMemberRenderer=new EnumerationMemberRenderer(this),this.dataTypeRenderer=new DataTypeRenderer(this),window.addEventListener("popstate",_asyncToGenerator(function*(){yield t.render()}))}render(){var e=this;return _asyncToGenerator(function*(){if(e.elem.innerHTML='<img src="https://raw.githubusercontent.com/semantifyit/schema-org-vocab-browser/main/images/loading.gif" alt="Loading Animation" style="margin-top: 6px">',yield e.init(),e.isListRendering())e.listRenderer.render();else if(e.isVocabRendering()){var r=new URLSearchParams(window.location.search).get("format");r&&"jsonld"===r?e.vocabRenderer.renderJSONLD():e.vocabRenderer.render()}else e.isTermRendering()&&e.renderTerm();e.addJSLinkEventListener(),document.body.scrollTop=document.documentElement.scrollTop=0})()}init(){var e=this;return _asyncToGenerator(function*(){e.listNeedsInit()&&(yield e.initList()),e.vocabNeedsInit()&&(yield e.initVocab())})()}listNeedsInit(){return this.type===TYPES.LIST&&!this.list}initList(){var e=this;return _asyncToGenerator(function*(){e.list=yield e.util.parseToObject(e.vocabOrVocabList)})()}vocabNeedsInit(){var e=new URLSearchParams(window.location.search).get("voc");return this.type===TYPES.LIST&&e&&e!==this.vocUID||this.type===TYPES.VOCAB&&!this.vocab}initVocab(){var e=this;return _asyncToGenerator(function*(){if(e.type===TYPES.VOCAB)e.vocab=yield e.util.parseToObject(e.vocabOrVocabList);else if(e.type===TYPES.LIST){var r=new URLSearchParams(window.location.search);for(var t of(e.vocUID=r.get("voc"),e.list["schema:hasPart"])){var n=t["@id"];if(n.split("/").pop()===e.vocUID){e.vocab=yield e.util.parseToObject(n),e.vocName=t["schema:name"];break}}}e.sdoAdapter=new SDOAdapter;var a=yield e.sdoAdapter.constructSDOVocabularyURL("latest","all-layers");yield e.sdoAdapter.addVocabularies([a,e.vocab]),e.namespaces=e.sdoAdapter.getVocabularies(),delete e.namespaces.schema;var i=Object.keys(e.namespaces);e.classes=e.sdoAdapter.getListOfClasses({fromVocabulary:i}),e.properties=e.sdoAdapter.getListOfProperties({fromVocabulary:i}),e.enumerations=e.sdoAdapter.getListOfEnumerations({fromVocabulary:i}),e.enumerationMembers=e.sdoAdapter.getListOfEnumerationMembers({fromVocabulary:i}),e.dataTypes=e.sdoAdapter.getListOfDataTypes({fromVocabulary:i})})()}isListRendering(){var e=new URLSearchParams(window.location.search);return this.type===TYPES.LIST&&!e.get("voc")}isVocabRendering(){var e=new URLSearchParams(window.location.search);return this.type===TYPES.LIST&&e.get("voc")&&!e.get("term")||this.type===TYPES.VOCAB&&!e.get("term")}isTermRendering(){return new URLSearchParams(window.location.search).get("term")}renderTerm(){var e=new URLSearchParams(window.location.search);switch(this.term=this.sdoAdapter.getTerm(e.get("term")),this.term.getTermType()){case"rdfs:Class":this.classRenderer.render();break;case"rdf:Property":this.propertyRenderer.render();break;case"schema:Enumeration":this.enumerationRenderer.render();break;case"soa:EnumerationMember":this.enumerationMemberRenderer.render();break;case"schema:DataType":this.dataTypeRenderer.render()}}addJSLinkEventListener(){var e=this,r=document.getElementsByClassName("a-js-link"),t=function(r){r.addEventListener("click",function(){var t=_asyncToGenerator(function*(t){t.ctrlKey?window.open(r.href):(history.pushState(null,null,r.href),yield e.render())});return function(e){return t.apply(this,arguments)}}())};for(var n of r)t(n)}}module.exports=SDOVocabBrowser;
